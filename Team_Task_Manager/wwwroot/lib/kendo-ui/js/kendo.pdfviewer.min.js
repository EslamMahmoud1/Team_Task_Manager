...
`))t.push({name:`span`,value:n,attributes:r});return n},Zi=function(e){e.altKey||e.shiftKey||e.ctrlKey||e.metaKey||(e.key===`Enter`||e.key===`Escape`&&S(this,zi,`f`))&&S(this,I,`m`,$i).call(this)},Qi=function(){if(S(this,Vi,`f`)!==null)return;let{page:{view:e},viewport:{rawDims:{pageWidth:t,pageHeight:n,pageX:r,pageY:i}}}=S(this,Li,`f`),a=!!S(this,Ri,`f`),o=a?S(this,Ri,`f`):S(this,Hi,`f`);for(let e of S(this,Ii,`f`))if(!o||yt.intersect(e.data.rect,o)!==null){o=e.data.rect,a=!0;break}let s=yt.normalizeRect([o[0],e[3]-o[1]+e[1],o[2],e[3]-o[3]+e[1]]),c=a?o[2]-o[0]+5:0,l=s[0]+c,u=s[1];C(this,Vi,[100*(l-r)/t,100*(u-i)/n],`f`);let{style:d}=S(this,L,`f`);d.left=`${S(this,Vi,`f`)[0]}%`,d.top=`${S(this,Vi,`f`)[1]}%`},$i=function(){C(this,zi,!S(this,zi,`f`),`f`),S(this,zi,`f`)?(S(this,I,`m`,ea).call(this),S(this,L,`f`).addEventListener(`click`,S(this,Mi,`f`)),S(this,L,`f`).addEventListener(`keydown`,S(this,ki,`f`))):(S(this,I,`m`,ta).call(this),S(this,L,`f`).removeEventListener(`click`,S(this,Mi,`f`)),S(this,L,`f`).removeEventListener(`keydown`,S(this,ki,`f`)))},ea=function(){S(this,Bi,`f`)||this.render(),this.isVisible?S(this,zi,`f`)&&S(this,L,`f`).classList.add(`focused`):(S(this,I,`m`,Qi).call(this),S(this,L,`f`).hidden=!1,S(this,L,`f`).style.zIndex=(parseInt(S(this,L,`f`).style.zIndex,10)+1e3).toString())},ta=function(){S(this,L,`f`).classList.remove(`focused`),!(S(this,zi,`f`)||!this.isVisible)&&(S(this,L,`f`).hidden=!0,S(this,L,`f`).style.zIndex=(parseInt(S(this,L,`f`).style.zIndex,10)-1e3).toString())};var xa=class extends da{constructor(e){super(e,{isRenderable:!0,ignoreBorder:!0}),this.textContent=null,this.textPosition=null,this.textContent=e.data.textContent,this.textPosition=e.data.textPosition,this.annotationEditorType=y.FREETEXT}render(){if(this.container.classList.add(`k-free-text-annotation`),this.textContent){let e=document.createElement(`div`);e.classList.add(`k-annotation-text-content`),e.setAttribute(`role`,`comment`);for(let t of this.textContent){let n=document.createElement(`span`);n.textContent=t,e.append(n)}this.container.append(e)}return this._editOnDoubleClick(),this.container}},Sa=class extends da{constructor(e){super(e,{isRenderable:!0,ignoreBorder:!0,createQuadrilaterals:!0})}render(){return this.container.classList.add(`k-highlight-annotation`),this.container}},Ca=class{constructor({div:e,accessibilityManager:t,annotationCanvasMap:n,annotationEditorUIManager:r,page:i,viewport:a}){na.add(this),this.div=null,this.page=null,this.viewport=null,this.zIndex=null,this._annotationEditorUIManager=null,ra.set(this,null),ia.set(this,null),aa.set(this,new Map),this.div=e,C(this,ra,t,`f`),C(this,ia,n,`f`),this.page=i,this.viewport=a,this.zIndex=0,this._annotationEditorUIManager=r}hide(){this.div&&(this.div.hidden=!0)}hasEditableAnnotations(){return S(this,aa,`f`).size>0}render(e){let{annotations:t}=e,n=this.div;ht(n,this.viewport);let r=new Map,i={data:null,layer:n,linkService:e.linkService,downloadManager:e.downloadManager,imageResourcesPath:e.imageResourcesPath||``,renderForms:e.renderForms!==!1,svgFactory:new _t,annotationStorage:e.annotationStorage||new vi,enableScripting:e.enableScripting===!0,hasJSActions:e.hasJSActions,fieldObjects:e.fieldObjects,parent:this,elements:null};for(let e of t){if(e.noHTML)continue;let t=e.annotationType===$t.POPUP;if(t){let t=r.get(e.id);if(!t)continue;i.elements=t}else{let{width:t,height:n}=la(e.rect);if(t<=0||n<=0)continue}i.data=e;let n=ua.create(i);if(!n.isRenderable)continue;if(!t&&e.popupRef){let t=r.get(e.popupRef);t?t.push(n):r.set(e.popupRef,[n])}let a=n.render();e.hidden&&(a.style.visibility=`hidden`),S(this,na,`m`,oa).call(this,a,e.id),n._isEditable&&(S(this,aa,`f`).set(n.data.id,n),this._annotationEditorUIManager?.renderAnnotationElement(n))}S(this,na,`m`,sa).call(this)}update({viewport:e}){let t=this.div;this.viewport=e,ht(t,e),S(this,na,`m`,sa).call(this),t.hidden=!1}getEditableAnnotations(){return Array.from(S(this,aa,`f`).values())}getEditableAnnotation(e){return S(this,aa,`f`).get(e)}destroy(){S(this,ia,`f`)?.clear(),this.div?.remove(),this.div=null}};ra=new WeakMap,ia=new WeakMap,aa=new WeakMap,na=new WeakSet,oa=function(e,t){let n=e.firstChild||e;n.id=`${on}${t}`,this.div.append(e),S(this,ra,`f`)?.moveElementInDOM(this.div,e,n,!1)},sa=function(){if(!S(this,ia,`f`))return;let e=this.div;for(let[t,n]of S(this,ia,`f`)){let r=e.querySelector(`[data-annotation-id="${t}"]`);if(!r)continue;n.className=`annotationContent k-annotation-content`;let{firstChild:i}=r;i?i.nodeName===`CANVAS`?i.replaceWith(n):!i.classList.contains(`annotationContent`)||!i.classList.contains(`k-annotation-content`)?i.before(n):i.after(n):r.append(n)}S(this,ia,`f`).clear()};var wa,Ta,Ea,Da,Oa=class{constructor({pdfPage:e,eventBus:t,linkService:n=null,annotationStorage:r=null,renderForms:i=!0,annotationCanvasMap:a=null,accessibilityManager:o=null,annotationEditorUIManager:s=null,onAppend:c=null}){wa.add(this),this.annotationLayer=null,this.pdfPage=null,this.linkService=null,this.annotationStorage=null,this._annotationCanvasMap=null,this._annotationEditorUIManager=null,this.div=null,this._cancelled=null,this._eventBus=null,this._accessibilityManager=null,Ta.set(this,null),Ea.set(this,null),this.renderForms=null,this.pdfPage=e,this.linkService=n,this.renderForms=i,this.annotationStorage=r,this._annotationCanvasMap=a,this._accessibilityManager=o,this._annotationEditorUIManager=s,C(this,Ta,c,`f`),this.annotationLayer=null,this.div=null,this._cancelled=!1,this._eventBus=n?.eventBus||t}render(e){return x(this,arguments,void 0,function*(e,t=`display`){if(this.div){if(this._cancelled||!this.annotationLayer)return;this.annotationLayer.update({viewport:e.clone({dontFlip:!0})});return}let[n]=yield Promise.all([this.pdfPage.getAnnotations({intent:t})]);if(this._cancelled)return;if(n.length===0){this.hide();return}let r=this.pdfPage._pageInfo?.view,i=Oe(`
        ...
        `);this.div=i,S(this,Ta,`f`)?.call(this,i),this.annotationLayer=new Ca({div:i,accessibilityManager:this._accessibilityManager,annotationCanvasMap:this._annotationCanvasMap,annotationEditorUIManager:this._annotationEditorUIManager,page:this.pdfPage,viewport:e.clone({dontFlip:!0})}),yield this.annotationLayer.render({annotations:n,renderForms:this.renderForms,linkService:this.linkService,annotationStorage:this.annotationStorage}),this.linkService.isInPresentationMode&&S(this,wa,`m`,Da).call(this,cr.FULLSCREEN),S(this,Ea,`f`)||(C(this,Ea,new AbortController,`f`),this._eventBus?._on(`presentationmodechanged`,e=>{S(this,wa,`m`,Da).call(this,e.state)},{signal:S(this,Ea,`f`).signal}))})}cancel(){this._cancelled=!0,S(this,Ea,`f`)?.abort(),C(this,Ea,null,`f`)}hide(){this.div&&(this.div.hidden=!0)}hasEditableAnnotations(){return!!this.annotationLayer?.hasEditableAnnotations()}destroy(){this.cancel(),this.annotationLayer?.destroy(),this.annotationLayer=null,S(this,Ea,`f`)?.abort(),C(this,Ea,null,`f`),this.div?.remove(),this.div=null}};Ta=new WeakMap,Ea=new WeakMap,wa=new WeakSet,Da=function(e){if(!this.div)return;let t=!1;switch(e){case cr.FULLSCREEN:t=!0;break;case cr.NORMAL:break;default:return}for(let e of this.div.childNodes)e.hasAttribute(`data-internal-link`)||(e.inert=t)};var ka,R,Aa,ja,z,Ma,Na,Pa,Fa,Ia=class{constructor({pageIndex:e}){ka.add(this),this.pageIndex=0,Aa.set(this,null),ja.set(this,0),z.set(this,new Map),Ma.set(this,new Map),this.pageIndex=e}setParent(e){if(!S(this,Aa,`f`)){C(this,Aa,e,`f`);return}if(S(this,Aa,`f`)!==e){if(S(this,z,`f`).size>0)for(let t of S(this,z,`f`).values())t.remove(),e.append(t);C(this,Aa,e,`f`)}}static get _svgFactory(){return pt(this,`_svgFactory`,new _t)}highlight(e,t,n,r=!1){var i,a;let o=(C(this,ja,(a=S(this,ja,`f`),i=a++,a),`f`),i),s=S(this,ka,`m`,Pa).call(this,e.box);s.classList.add(`k-highlight`),e.free;let c=R._svgFactory.createElement(`defs`);s.append(c);let l=R._svgFactory.createElement(`path`);c.append(l);let u=`path_p${this.pageIndex}_${o}`;l.setAttribute(`id`,u),l.setAttribute(`d`,e.toSVGPath()),r&&S(this,Ma,`f`).set(o,l);let d=S(this,ka,`m`,Fa).call(this,c,u),f=R._svgFactory.createElement(`use`);return s.append(f),s.setAttribute(`fill`,t),s.setAttribute(`fill-opacity`,n),f.setAttribute(`href`,`#${u}`),S(this,z,`f`).set(o,s),{id:o,clipPathId:`url(#${d})`}}highlightOutline(e){var t,n;let r=(C(this,ja,(n=S(this,ja,`f`),t=n++,n),`f`),t),i=S(this,ka,`m`,Pa).call(this,e.box);i.classList.add(`k-highlight-outline`);let a=R._svgFactory.createElement(`defs`);i.append(a);let o=R._svgFactory.createElement(`path`);a.append(o);let s=`path_p${this.pageIndex}_${r}`;o.setAttribute(`id`,s),o.setAttribute(`d`,e.toSVGPath()),o.setAttribute(`vector-effect`,`non-scaling-stroke`);let c;if(e.free){let e=R._svgFactory.createElement(`mask`);a.append(e),c=`mask_p${this.pageIndex}_${r}`,e.setAttribute(`id`,c),e.setAttribute(`maskUnits`,`objectBoundingBox`);let t=R._svgFactory.createElement(`rect`);e.append(t),t.setAttribute(`width`,`1`),t.setAttribute(`height`,`1`),t.setAttribute(`fill`,`white`);let n=R._svgFactory.createElement(`use`);e.append(n),n.setAttribute(`href`,`#${s}`),n.setAttribute(`stroke`,`none`),n.setAttribute(`fill`,`black`),n.setAttribute(`fill-rule`,`nonzero`)}let l=R._svgFactory.createElement(`use`);i.append(l),l.setAttribute(`href`,`#${s}`),c&&l.setAttribute(`mask`,`url(#${c})`);let u=l.cloneNode();return i.append(u),S(this,z,`f`).set(r,i),r}finalizeLine(e,t){let n=S(this,Ma,`f`).get(e);S(this,Ma,`f`).delete(e),this.updateBox(e,t.box),n.setAttribute(`d`,t.toSVGPath())}updateLine(e,t){S(this,z,`f`).get(e).firstChild.firstChild.setAttribute(`d`,t.toSVGPath())}removeFreeHighlight(e){this.remove(e),S(this,Ma,`f`).delete(e)}updatePath(e,t){S(this,Ma,`f`).get(e).setAttribute(`d`,t.toSVGPath())}updateBox(e,t){S(R,R,`m`,Na).call(R,S(this,z,`f`).get(e),t)}show(e,t){S(this,z,`f`).get(e).classList.toggle(`k-hidden`,!t)}rotate(e,t){S(this,z,`f`).get(e).setAttribute(`data-main-rotation`,t)}changeColor(e,t){S(this,z,`f`).get(e).setAttribute(`fill`,t)}changeOpacity(e,t){S(this,z,`f`).get(e).setAttribute(`fill-opacity`,t)}addClass(e,t){S(this,z,`f`).get(e).classList.add(t)}removeClass(e,t){S(this,z,`f`).get(e).classList.remove(t)}remove(e){S(this,Aa,`f`)!==null&&(S(this,z,`f`).get(e).remove(),S(this,z,`f`).delete(e))}destroy(){C(this,Aa,null,`f`);for(let e of S(this,z,`f`).values())e.remove();S(this,z,`f`).clear()}};R=Ia,Aa=new WeakMap,ja=new WeakMap,z=new WeakMap,Ma=new WeakMap,ka=new WeakSet,Na=function(e,{x:t=0,y:n=0,width:r=1,height:i=1}={}){let{style:a}=e;a.top=`${100*n}%`,a.left=`${100*t}%`,a.width=`${100*r-.2}%`,a.height=`${100*i-.2}%`},Pa=function(e){let t=R._svgFactory.create(1,1,!0);return S(this,Aa,`f`).append(t),t.setAttribute(`aria-hidden`,!0),S(R,R,`m`,Na).call(R,t,e),t},Fa=function(e,t){let n=R._svgFactory.createElement(`clipPath`);e.append(n);let r=`clip_${t}`;n.setAttribute(`id`,r),n.setAttribute(`clipPathUnits`,`objectBoundingBox`);let i=R._svgFactory.createElement(`use`);return n.append(i),i.setAttribute(`href`,`#${t}`),r};var La,Ra=class{constructor(e){this.pageIndex=null,this._cancelled=null,La.set(this,null),this.pageIndex=e.pageIndex}render(){return x(this,arguments,void 0,function*(e=`display`){e!==`display`||S(this,La,`f`)||C(this,La,new Ia({pageIndex:this.pageIndex}),`f`)})}cancel(){S(this,La,`f`)&&(S(this,La,`f`)?.destroy(),C(this,La,null,`f`))}setParent(e){S(this,La,`f`)?.setParent(e)}getDrawLayer(){return S(this,La,`f`)}destroy(){this.cancel()}};La=new WeakMap;var B,V,za,H,Ba,Va,U,Ha,Ua,Wa,Ga,Ka,qa,Ja,Ya,Xa,Za;let Qa=/\r\n?|\n/g;var $a=class extends P{constructor(e){super(Object.assign(Object.assign({},e),{name:`k-free-text-editor freeTextEditor`})),B.add(this),this.editorDiv=null,this.overlayDiv=null,za.set(this,void 0),H.set(this,``),Ba.set(this,`${this.id}-editor`),Va.set(this,null),U.set(this,void 0),Ha.set(this,null),C(this,za,e.color||V._defaultColor||P._defaultLineColor,`f`),C(this,U,e.fontSize||V._defaultFontSize,`f`)}static initialize(e,t){P.initialize(e,t,{strings:[`pdfjs-free-text-default-content`]});let n=getComputedStyle(document.documentElement);this._internalPadding=parseFloat(n.getPropertyValue(`--freetext-padding`))||2}static updateDefaultParams(e,t){switch(e){case b.FREETEXT_SIZE:V._defaultFontSize=t;break;case b.FREETEXT_COLOR:V._defaultColor=t;break;default:break}}updateParams(e,t){switch(e){case b.FREETEXT_SIZE:S(this,B,`m`,Ua).call(this,t);break;case b.FREETEXT_COLOR:S(this,B,`m`,Wa).call(this,t);break;default:break}}static get defaultPropertiesToUpdate(){return[[b.FREETEXT_SIZE,V._defaultFontSize],[b.FREETEXT_COLOR,V._defaultColor||P._defaultLineColor]]}get propertiesToUpdate(){return[[b.FREETEXT_SIZE,S(this,U,`f`)],[b.FREETEXT_COLOR,S(this,za,`f`)]]}_translateEmpty(e,t){this._uiManager.translateSelectedEditors(e,t,!0)}getInitialTranslation(){let e=this.parentScale;return[-V._internalPadding*e,-(V._internalPadding+S(this,U,`f`))*e]}rebuild(){this.parent&&(super.rebuild(),this.div!==null&&(this.isAttachedToDOM||this.parent.add(this)))}enableEditMode(){if(this.isInEditMode())return;this.parent.setEditingState(!1),this.parent.updateToolbar(y.FREETEXT),super.enableEditMode(),this.overlayDiv.classList.remove(`enabled`),this.editorDiv.contentEditable=!0,this._isDraggable=!1,this.div.removeAttribute(`aria-activedescendant`),C(this,Va,new AbortController,`f`);let e=this._uiManager.combinedSignal(S(this,Va,`f`));this.editorDiv.addEventListener(`keydown`,this.editorDivKeydown.bind(this),{signal:e}),this.editorDiv.addEventListener(`focus`,this.editorDivFocus.bind(this),{signal:e}),this.editorDiv.addEventListener(`blur`,this.editorDivBlur.bind(this),{signal:e}),this.editorDiv.addEventListener(`input`,this.editorDivInput.bind(this),{signal:e}),this.editorDiv.addEventListener(`paste`,this.editorDivPaste.bind(this),{signal:e})}disableEditMode(){this.isInEditMode()&&(this.parent.setEditingState(!0),super.disableEditMode(),this.editorDiv.contentEditable=!1,this.div.setAttribute(`aria-activedescendant`,S(this,Ba,`f`)),this._isDraggable=!0,S(this,Va,`f`)?.abort(),C(this,Va,null,`f`),this.div.focus({preventScroll:!0}),this.isEditing=!1)}focusin(e){this._focusEventsAllowed&&this._uiManager?.getMode()===y.FREETEXT&&(super.focusin(e),e.target!==this.editorDiv&&this.editorDiv.focus())}onceAdded(){this.width||(this.enableEditMode(),this.editorDiv.focus(),this._initialOptions?.isCentered&&this.center(),this._initialOptions=null)}isEmpty(){return!this.editorDiv||(this.editorDiv?.innerText)?.trim()===``}remove(){this.isEditing=!1,this.parent&&this.parent.setEditingState(!0),super.remove()}commit(){if(!this.isInEditMode())return;super.commit(),this.disableEditMode();let e=S(this,H,`f`),t=C(this,H,S(this,B,`m`,Ga).call(this).trimEnd(),`f`);if(e===t)return;let n=e=>{if(C(this,H,e,`f`),!e){this.remove();return}S(this,B,`m`,Ja).call(this),this._uiManager.rebuild(this),S(this,B,`m`,Ka).call(this)};this.addCommands({cmd:()=>{n(t)},undo:()=>{n(e)},mustExec:!1}),S(this,B,`m`,Ka).call(this)}shouldGetKeyboardEvents(){return this.isInEditMode()}enterInEditMode(){this.enableEditMode(),this.editorDiv.focus()}dblclick(e){e&&this.enterInEditMode()}keydown(e){e.target===this.div&&e.key===`Enter`&&(this.enterInEditMode(),e.preventDefault())}editorDivKeydown(){}editorDivFocus(){this.isEditing=!0}editorDivBlur(){this.isEditing=!1}editorDivInput(){}disableEditing(){this.editorDiv.setAttribute(`role`,`comment`),this.editorDiv.removeAttribute(`aria-multiline`)}enableEditing(){this.editorDiv.setAttribute(`role`,`textbox`),this.editorDiv.setAttribute(`aria-multiline`,!0)}render(){if(this.div)return this.div;let e,t;this.width&&(e=this.x,t=this.y),super.render(),this.editorDiv=document.createElement(`div`),this.editorDiv.className=`k-internal internal`,this.editorDiv.setAttribute(`id`,S(this,Ba,`f`)),this.editorDiv.setAttribute(`data-l10n-id`,`pdfjs-free-text`),this.enableEditing(),this.editorDiv?.setAttribute(`default-content`,this._uiManager.pdfViewer.options.messages.freeTextEditorPlaceholder),this.editorDiv.contentEditable=!0;let{style:n}=this.editorDiv;if(n.fontSize=`calc(${S(this,U,`f`)}px * var(--scale-factor))`,n.color=S(this,za,`f`),this.div.append(this.editorDiv),this.overlayDiv=document.createElement(`div`),this.div.append(this.overlayDiv),Rr(this,this.div,[`dblclick`,`keydown`]),this.width){let[n,r]=this.parentDimensions;if(this.annotationElementId){let{position:i}=S(this,Ha,`f`),[a,o]=this.getInitialTranslation();[a,o]=this.pageTranslationToScreen(a,o);let[s,c]=this.pageDimensions,[l,u]=this.pageTranslation,d,f;switch(this.rotation){case 0:d=e+(i[0]-l)/s,f=t+this.height-(i[1]-u)/c;break;case 90:d=e+(i[0]-l)/s,f=t-(i[1]-u)/c,[a,o]=[o,-a];break;case 180:d=e-this.width+(i[0]-l)/s,f=t-(i[1]-u)/c,[a,o]=[-a,-o];break;case 270:d=e+(i[0]-l-this.height*c)/s,f=t+(i[1]-u-this.width*s)/c,[a,o]=[-o,a];break;default:break}this.setAt(d*n,f*r,a,o)}else this.setAt(e*n,t*r,this.width*n,this.height*r);S(this,B,`m`,Ja).call(this),this._isDraggable=!0,this.editorDiv.contentEditable=!1}else this._isDraggable=!1,this.editorDiv.contentEditable=!0;return this.div}editorDivPaste(e){let t=e.clipboardData||window.clipboardData,{types:n}=t;if(n.length===1&&n[0]===`text/plain`)return;e.preventDefault();let r=S(V,V,`m`,Xa).call(V,t.getData(`text`)||``).replaceAll(Qa,`
...
`)){a.insertNode(document.createTextNode(r)),this.editorDiv.normalize(),i.collapseToStart();return}let{startContainer:o,startOffset:s}=a,c=[],l=[];if(o.nodeType===Node.TEXT_NODE){let e=o.parentElement;if(l.push(o.nodeValue.slice(s).replaceAll(Qa,``)),e!==this.editorDiv){let t=c;for(let n of this.editorDiv.childNodes){if(n===e){t=l;continue}t.push(S(V,V,`m`,qa).call(V,n))}}c.push(o.nodeValue.slice(0,s).replaceAll(Qa,``))}else if(o===this.editorDiv){let e=c,t=0;for(let n of this.editorDiv.childNodes)t++===s&&(e=l),e.push(S(V,V,`m`,qa).call(V,n))}C(this,H,`${c.join(`
`)}${r}${l.join(`
`)}`,`f`),S(this,B,`m`,Ja).call(this);let u=new Range,d=c.reduce((e,t)=>e+t.length,0);for(let{firstChild:e}of this.editorDiv.childNodes)if(e.nodeType===Node.TEXT_NODE){let t=e.nodeValue.length;if(d<=t){u.setStart(e,d),u.setEnd(e,d);break}d-=t}i.removeAllRanges(),i.addRange(u)}get contentDiv(){return this.editorDiv}static deserialize(e,t,n){let r=null;if(e instanceof xa){let{data:{defaultAppearanceData:{fontSize:t,fontColor:n},rect:i,rotation:a,id:o},textContent:s,textPosition:c,parent:{page:{pageNumber:l}}}=e;if(!s||s.length===0)return null;r=e={annotationType:y.FREETEXT,color:Array.from(n),fontSize:t,value:s.join(`
`),position:c,pageIndex:l-1,rect:i.slice(0),rotation:a,id:o,deleted:!1}}let i=super.deserialize(e,t,n);return C(i,U,e.fontSize,`f`),C(i,za,yt.makeHexColor(...e.color),`f`),C(i,H,S(V,V,`m`,Xa).call(V,e.value),`f`),i.annotationElementId=e.id||null,C(i,Ha,r,`f`),i}serialize(e=!1){if(this.isEmpty())return null;if(this.deleted)return{pageIndex:this.pageIndex,id:this.annotationElementId,deleted:!0};let t=V._internalPadding*this.parentScale,n=this.getRect(t,t),r=P._colorManager.convert(this.isAttachedToDOM?getComputedStyle(this.editorDiv).color:S(this,za,`f`)),i={annotationType:y.FREETEXT,color:r,fontSize:S(this,U,`f`),value:S(this,B,`m`,Ya).call(this),pageIndex:this.pageIndex,rect:n,rotation:this.rotation,structTreeParentId:this._structTreeParentId};return e?i:this.annotationElementId&&!S(this,B,`m`,Za).call(this,i)?null:(i.id=this.annotationElementId,i)}renderAnnotationElement(e){let t=super.renderAnnotationElement(e);if(this.deleted)return t;let{style:n}=t;n.fontSize=`calc(${S(this,U,`f`)}px * var(--scale-factor))`,n.color=S(this,za,`f`),t.replaceChildren();for(let e of S(this,H,`f`).split(`
`)){let n=document.createElement(`div`);n.append(e?document.createTextNode(e):document.createElement(`br`)),t.append(n)}let r=V._internalPadding*this.parentScale;return e.updateEdited({rect:this.getRect(r,r),popupContent:S(this,H,`f`)}),t}resetAnnotationElement(e){super.resetAnnotationElement(e),e.resetEdited()}toJSON(){return this.serialize()}};V=$a,za=new WeakMap,H=new WeakMap,Ba=new WeakMap,Va=new WeakMap,U=new WeakMap,Ha=new WeakMap,B=new WeakSet,Ua=function(e){let t=e=>{this.editorDiv.style.fontSize=`calc(${e}px * var(--scale-factor))`,this.translate(0,-(e-S(this,U,`f`))*this.parentScale),C(this,U,e,`f`),S(this,B,`m`,Ka).call(this)},n=S(this,U,`f`);this.addCommands({cmd:t.bind(this,e),undo:t.bind(this,n),post:this._uiManager.updateUI.bind(this._uiManager,this),mustExec:!0,type:b.FREETEXT_SIZE,overwriteIfSameType:!0,keepUndo:!0})},Wa=function(e){let t=e=>{C(this,za,this.editorDiv.style.color=e,`f`)},n=S(this,za,`f`);this.addCommands({cmd:t.bind(this,e),undo:t.bind(this,n),post:this._uiManager.updateUI.bind(this._uiManager,this),mustExec:!0,type:b.FREETEXT_COLOR,overwriteIfSameType:!0,keepUndo:!0})},Ga=function(){let e=[];this.editorDiv.normalize();for(let t of this.editorDiv.childNodes)e.push(S(V,V,`m`,qa).call(V,t));return e.join(`
`)},Ka=function(){let[e,t]=this.parentDimensions,n;if(this.isAttachedToDOM)n=this.div.getBoundingClientRect();else{let{currentLayer:e,div:t}=this,r=t.style.display,i=t.classList.contains(`hidden`)||t.classList.contains(`k-hidden`);t.classList.remove(`hidden`),t.classList.remove(`k-hidden`),t.style.display=`hidden`,e.div.append(this.div),n=t.getBoundingClientRect(),t.remove(),t.style.display=r,t.classList.toggle(`k-hidden`,i)}this.rotation%180==this.parentRotation%180?(this.width=n.width/e,this.height=n.height/t):(this.width=n.height/e,this.height=n.width/t),this.fixAndSetPosition()},qa=function(e){return(e.nodeType===Node.TEXT_NODE?e.nodeValue:e.innerText).replaceAll(Qa,``)},Ja=function(){if(this.editorDiv.replaceChildren(),S(this,H,`f`))for(let e of S(this,H,`f`).split(`
`)){let t=document.createElement(`div`);t.append(e?document.createTextNode(e):document.createElement(`br`)),this.editorDiv.append(t)}},Ya=function(){return S(this,H,`f`).replaceAll(`\xA0`,` `)},Xa=function(e){return e.replaceAll(` `,`\xA0`)},Za=function(e){let{value:t,fontSize:n,color:r,pageIndex:i}=S(this,Ha,`f`);return this._hasBeenMoved||e.value!==t||e.fontSize!==n||e.color.some((e,t)=>e!==r[t])||e.pageIndex!==i},$a._freeTextDefaultContent=``,$a._internalPadding=0,$a._defaultColor=`#000000`,$a._defaultFontSize=10,$a._type=`freetext`,$a._editorType=y.FREETEXT;var eo,to,no,ro,io,ao,oo,so,co,lo,uo,fo,po,mo,ho,go,_o,vo,W,yo,bo,xo,So,Co,wo,To,Eo,Do,Oo,ko,Ao,jo,Mo,No,Po,G,Fo,K,Io,Lo,Ro,zo=class{constructor(e,t=0,n=0,r=!0){eo.add(this),to.set(this,void 0),no.set(this,[]),ro.set(this,[]);let i=1/0,a=-1/0,o=1/0,s=-1/0,c=10**-4;for(let{x:n,y:r,width:l,height:u}of e){let e=Math.floor((n-t)/c)*c,d=Math.ceil((n+l+t)/c)*c,f=Math.floor((r-t)/c)*c,p=Math.ceil((r+u+t)/c)*c,m=[e,f,p,!0],h=[d,f,p,!1];S(this,no,`f`).push(m,h),i=Math.min(i,e),a=Math.max(a,d),o=Math.min(o,f),s=Math.max(s,p)}let l=a-i+2*n,u=s-o+2*n,d=i-n,f=o-n,p=S(this,no,`f`).at(r?-1:-2),m=[p[0],p[2]];for(let e of S(this,no,`f`)){let[t,n,r]=e;e[0]=(t-d)/l,e[1]=(n-f)/u,e[2]=(r-f)/u}C(this,to,{x:d,y:f,width:l,height:u,lastPoint:m},`f`)}getOutlines(){S(this,no,`f`).sort((e,t)=>e[0]-t[0]||e[1]-t[1]||e[2]-t[2]);let e=[];for(let t of S(this,no,`f`))t[3]?(e.push(...S(this,eo,`m`,co).call(this,t)),S(this,eo,`m`,oo).call(this,t)):(S(this,eo,`m`,so).call(this,t),e.push(...S(this,eo,`m`,co).call(this,t)));return S(this,eo,`m`,io).call(this,e)}};to=new WeakMap,no=new WeakMap,ro=new WeakMap,eo=new WeakSet,io=function(e){let t=[],n=new Set;for(let n of e){let[e,r,i]=n;t.push([e,r,n],[e,i,n])}t.sort((e,t)=>e[1]-t[1]||e[0]-t[0]);for(let e=0,r=t.length;e<r;e+=2){let r=t[e][2],i=t[e+1][2];r.push(i),i.push(r),n.add(r),n.add(i)}let r=[],i;for(;n.size>0;){let e=n.values().next().value,[t,a,o,s,c]=e;n.delete(e);let l=t,u=a;for(i=[t,o],r.push(i);;){let e;if(n.has(s))e=s;else if(n.has(c))e=c;else break;n.delete(e),[t,a,o,s,c]=e,l!==t&&(i.push(l,u,t,u===a?a:o),l=t),u=u===a?o:a}i.push(l,u)}return new Vo(r,S(this,to,`f`))},ao=function(e){let t=S(this,ro,`f`),n=0,r=t.length-1;for(;n<=r;){let i=n+r>>1,a=t[i][0];if(a===e)return i;a<e?n=i+1:r=i-1}return r+1},oo=function([,e,t]){let n=S(this,eo,`m`,ao).call(this,e);S(this,ro,`f`).splice(n,0,[e,t])},so=function([,e,t]){let n=S(this,eo,`m`,ao).call(this,e);for(let r=n;r<S(this,ro,`f`).length;r++){let[n,i]=S(this,ro,`f`)[r];if(n!==e)break;if(n===e&&i===t){S(this,ro,`f`).splice(r,1);return}}for(let r=n-1;r>=0;r--){let[n,i]=S(this,ro,`f`)[r];if(n!==e)break;if(n===e&&i===t){S(this,ro,`f`).splice(r,1);return}}},co=function(e){let[t,n,r]=e,i=[[t,n,r]],a=S(this,eo,`m`,ao).call(this,r);for(let e=0;e<a;e++){let[n,r]=S(this,ro,`f`)[e];for(let e=0,a=i.length;e<a;e++){let[,o,s]=i[e];if(!(r<=o||s<=n)){if(o>=n){if(s>r)i[e][1]=r;else{if(a===1)return[];i.splice(e,1),e--,a--}continue}i[e][2]=n,s>r&&i.push([t,r,s])}}}return i};var Bo=class{toSVGPath(){throw Error("Abstract method `toSVGPath` must be implemented.")}get box(){throw Error("Abstract getter `box` must be implemented.")}serialize([e,t,n,r]){}get free(){return this instanceof Uo}},Vo=class extends Bo{constructor(e,t){super(),lo.set(this,void 0),uo.set(this,void 0),C(this,uo,e,`f`),C(this,lo,t,`f`)}toSVGPath(){let e=[];for(let t of S(this,uo,`f`)){let[n,r]=t;e.push(`M${n} ${r}`);for(let i=2;i<t.length;i+=2){let a=t[i],o=t[i+1];a===n?(e.push(`V${o}`),r=o):o===r&&(e.push(`H${a}`),n=a)}e.push(`Z`)}return e.join(` `)}serialize([e,t,n,r]){let i=[],a=n-e,o=r-t;for(let t of S(this,uo,`f`)){let n=Array(t.length);for(let i=0;i<t.length;i+=2)n[i]=e+t[i]*a,n[i+1]=r-t[i+1]*o;i.push(n)}return i}get box(){return S(this,lo,`f`)}};lo=new WeakMap,uo=new WeakMap;var Ho=class{constructor({x:e,y:t},n,r,i,a,o=0){fo.add(this),mo.set(this,void 0),ho.set(this,[]),go.set(this,void 0),_o.set(this,void 0),vo.set(this,[]),W.set(this,new Float64Array(18)),yo.set(this,void 0),bo.set(this,void 0),xo.set(this,void 0),So.set(this,void 0),Co.set(this,void 0),wo.set(this,void 0),To.set(this,[]),C(this,mo,n,`f`),C(this,wo,i*r,`f`),C(this,_o,a,`f`),S(this,W,`f`).set([NaN,NaN,NaN,NaN,e,t],6),C(this,go,o,`f`),C(this,So,S(po,po,`f`,Eo)*r,`f`),C(this,xo,S(po,po,`f`,Oo)*r,`f`),C(this,Co,r,`f`),S(this,To,`f`).push(e,t)}get free(){return!0}isEmpty(){return isNaN(S(this,W,`f`)[8])}add({x:e,y:t}){C(this,yo,e,`f`),C(this,bo,t,`f`);let[n,r,i,a]=S(this,mo,`f`),[o,s,c,l]=S(this,W,`f`).subarray(8,12),u=e-c,d=t-l,f=Math.hypot(u,d);if(f<S(this,xo,`f`))return!1;let p=f-S(this,So,`f`),m=p/f,h=m*u,ee=m*d,g=o,te=s;o=c,s=l,c+=h,l+=ee,S(this,To,`f`)?.push(e,t);let ne=-ee/p,re=h/p,ie=ne*S(this,wo,`f`),ae=re*S(this,wo,`f`);return S(this,W,`f`).set(S(this,W,`f`).subarray(2,8),0),S(this,W,`f`).set([c+ie,l+ae],4),S(this,W,`f`).set(S(this,W,`f`).subarray(14,18),12),S(this,W,`f`).set([c-ie,l-ae],16),isNaN(S(this,W,`f`)[6])?(S(this,vo,`f`).length===0&&(S(this,W,`f`).set([o+ie,s+ae],2),S(this,vo,`f`).push(NaN,NaN,NaN,NaN,(o+ie-n)/i,(s+ae-r)/a),S(this,W,`f`).set([o-ie,s-ae],14),S(this,ho,`f`).push(NaN,NaN,NaN,NaN,(o-ie-n)/i,(s-ae-r)/a)),S(this,W,`f`).set([g,te,o,s,c,l],6),!this.isEmpty()):(S(this,W,`f`).set([g,te,o,s,c,l],6),Math.abs(Math.atan2(te-s,g-o)-Math.atan2(ee,h))<Math.PI/2?([o,s,c,l]=S(this,W,`f`).subarray(2,6),S(this,vo,`f`).push(NaN,NaN,NaN,NaN,((o+c)/2-n)/i,((s+l)/2-r)/a),[o,s,g,te]=S(this,W,`f`).subarray(14,18),S(this,ho,`f`).push(NaN,NaN,NaN,NaN,((g+o)/2-n)/i,((te+s)/2-r)/a),!0):([g,te,o,s,c,l]=S(this,W,`f`).subarray(0,6),S(this,vo,`f`).push(((g+5*o)/6-n)/i,((te+5*s)/6-r)/a,((5*o+c)/6-n)/i,((5*s+l)/6-r)/a,((o+c)/2-n)/i,((s+l)/2-r)/a),[c,l,o,s,g,te]=S(this,W,`f`).subarray(12,18),S(this,ho,`f`).push(((g+5*o)/6-n)/i,((te+5*s)/6-r)/a,((5*o+c)/6-n)/i,((5*s+l)/6-r)/a,((o+c)/2-n)/i,((s+l)/2-r)/a),!0))}toSVGPath(){if(this.isEmpty())return``;let e=S(this,vo,`f`),t=S(this,ho,`f`),n=S(this,W,`f`).subarray(4,6),r=S(this,W,`f`).subarray(16,18),[i,a,o,s]=S(this,mo,`f`),[c,l,u,d]=S(this,fo,`m`,ko).call(this);if(isNaN(S(this,W,`f`)[6])&&!this.isEmpty())return`M${(S(this,W,`f`)[2]-i)/o} ${(S(this,W,`f`)[3]-a)/s} L${(S(this,W,`f`)[4]-i)/o} ${(S(this,W,`f`)[5]-a)/s} L${c} ${l} L${u} ${d} L${(S(this,W,`f`)[16]-i)/o} ${(S(this,W,`f`)[17]-a)/s} L${(S(this,W,`f`)[14]-i)/o} ${(S(this,W,`f`)[15]-a)/s} Z`;let f=[];f.push(`M${e[4]} ${e[5]}`);for(let t=6;t<e.length;t+=6)isNaN(e[t])?f.push(`L${e[t+4]} ${e[t+5]}`):f.push(`C${e[t]} ${e[t+1]} ${e[t+2]} ${e[t+3]} ${e[t+4]} ${e[t+5]}`);f.push(`L${(n[0]-i)/o} ${(n[1]-a)/s} L${c} ${l} L${u} ${d} L${(r[0]-i)/o} ${(r[1]-a)/s}`);for(let e=t.length-6;e>=6;e-=6)isNaN(t[e])?f.push(`L${t[e+4]} ${t[e+5]}`):f.push(`C${t[e]} ${t[e+1]} ${t[e+2]} ${t[e+3]} ${t[e+4]} ${t[e+5]}`);return f.push(`L${t[4]} ${t[5]} Z`),f.join(` `)}getOutlines(){let e=S(this,vo,`f`),t=S(this,ho,`f`),n=S(this,W,`f`),r=n.subarray(4,6),i=n.subarray(16,18),[a,o,s,c]=S(this,mo,`f`),l=new Float64Array((S(this,To,`f`)?.length??0)+2);for(let e=0,t=l.length-2;e<t;e+=2)l[e]=(S(this,To,`f`)[e]-a)/s,l[e+1]=(S(this,To,`f`)[e+1]-o)/c;l[l.length-2]=(S(this,yo,`f`)-a)/s,l[l.length-1]=(S(this,bo,`f`)-o)/c;let[u,d,f,p]=S(this,fo,`m`,ko).call(this);if(isNaN(n[6])&&!this.isEmpty()){let e=new Float64Array(36);return e.set([NaN,NaN,NaN,NaN,(n[2]-a)/s,(n[3]-o)/c,NaN,NaN,NaN,NaN,(n[4]-a)/s,(n[5]-o)/c,NaN,NaN,NaN,NaN,u,d,NaN,NaN,NaN,NaN,f,p,NaN,NaN,NaN,NaN,(n[16]-a)/s,(n[17]-o)/c,NaN,NaN,NaN,NaN,(n[14]-a)/s,(n[15]-o)/c],0),new Uo(e,l,S(this,mo,`f`),S(this,Co,`f`),S(this,go,`f`),S(this,_o,`f`))}let m=new Float64Array(S(this,vo,`f`).length+24+S(this,ho,`f`).length),h=e.length;for(let t=0;t<h;t+=2){if(isNaN(e[t])){m[t]=m[t+1]=NaN;continue}m[t]=e[t],m[t+1]=e[t+1]}m.set([NaN,NaN,NaN,NaN,(r[0]-a)/s,(r[1]-o)/c,NaN,NaN,NaN,NaN,u,d,NaN,NaN,NaN,NaN,f,p,NaN,NaN,NaN,NaN,(i[0]-a)/s,(i[1]-o)/c],h),h+=24;for(let e=t.length-6;e>=6;e-=6)for(let n=0;n<6;n+=2){if(isNaN(t[e+n])){m[h]=m[h+1]=NaN,h+=2;continue}m[h]=t[e+n],m[h+1]=t[e+n+1],h+=2}return m.set([NaN,NaN,NaN,NaN,t[4],t[5]],h),new Uo(m,l,S(this,mo,`f`),S(this,Co,`f`),S(this,go,`f`),S(this,_o,`f`))}};po=Ho,mo=new WeakMap,ho=new WeakMap,go=new WeakMap,_o=new WeakMap,vo=new WeakMap,W=new WeakMap,yo=new WeakMap,bo=new WeakMap,xo=new WeakMap,So=new WeakMap,Co=new WeakMap,wo=new WeakMap,To=new WeakMap,fo=new WeakSet,ko=function(){let e=S(this,W,`f`).subarray(4,6),t=S(this,W,`f`).subarray(16,18),[n,r,i,a]=S(this,mo,`f`);return[(S(this,yo,`f`)+(e[0]-t[0])/2-n)/i,(S(this,bo,`f`)+(e[1]-t[1])/2-r)/a,(S(this,yo,`f`)+(t[0]-e[0])/2-n)/i,(S(this,bo,`f`)+(t[1]-e[1])/2-r)/a]},Eo={value:8},Do={value:2},Oo={value:S(po,po,`f`,Eo)+S(po,po,`f`,Do)};var Uo=class extends Bo{constructor(e,t,n,r,i,a){super(),Ao.add(this),jo.set(this,void 0),Mo.set(this,null),No.set(this,void 0),Po.set(this,void 0),G.set(this,void 0),Fo.set(this,void 0),K.set(this,void 0),C(this,K,e,`f`),C(this,G,t,`f`),C(this,jo,n,`f`),C(this,Fo,r,`f`),C(this,No,i,`f`),C(this,Po,a,`f`),S(this,Ao,`m`,Ro).call(this,a);let{x:o,y:s,width:c,height:l}=S(this,Mo,`f`);for(let t=0,n=e.length;t<n;t+=2)e[t]=(e[t]-o)/c,e[t+1]=(e[t+1]-s)/l;for(let e=0,n=t.length;e<n;e+=2)t[e]=(t[e]-o)/c,t[e+1]=(t[e+1]-s)/l}toSVGPath(){let e=[`M${S(this,K,`f`)[4]} ${S(this,K,`f`)[5]}`];for(let t=6,n=S(this,K,`f`).length;t<n;t+=6){if(isNaN(S(this,K,`f`)[t])){e.push(`L${S(this,K,`f`)[t+4]} ${S(this,K,`f`)[t+5]}`);continue}e.push(`C${S(this,K,`f`)[t]} ${S(this,K,`f`)[t+1]} ${S(this,K,`f`)[t+2]} ${S(this,K,`f`)[t+3]} ${S(this,K,`f`)[t+4]} ${S(this,K,`f`)[t+5]}`)}return e.push(`Z`),e.join(` `)}serialize([e,t,n,r],i){let a=n-e,o=r-t,s,c;switch(i){case 0:s=S(this,Ao,`m`,Io).call(this,S(this,K,`f`),e,r,a,-o),c=S(this,Ao,`m`,Io).call(this,S(this,G,`f`),e,r,a,-o);break;case 90:s=S(this,Ao,`m`,Lo).call(this,S(this,K,`f`),e,t,a,o),c=S(this,Ao,`m`,Lo).call(this,S(this,G,`f`),e,t,a,o);break;case 180:s=S(this,Ao,`m`,Io).call(this,S(this,K,`f`),n,t,-a,o),c=S(this,Ao,`m`,Io).call(this,S(this,G,`f`),n,t,-a,o);break;case 270:s=S(this,Ao,`m`,Lo).call(this,S(this,K,`f`),n,r,-a,-o),c=S(this,Ao,`m`,Lo).call(this,S(this,G,`f`),n,r,-a,-o);break;default:break}return{outline:Array.from(s),points:[Array.from(c)]}}get box(){return S(this,Mo,`f`)}getNewOutline(e,t){let{x:n,y:r,width:i,height:a}=S(this,Mo,`f`),[o,s,c,l]=S(this,jo,`f`),u=i*c,d=a*l,f=n*c+o,p=r*l+s,m=new Ho({x:S(this,G,`f`)[0]*u+f,y:S(this,G,`f`)[1]*d+p},S(this,jo,`f`),S(this,Fo,`f`),e,S(this,Po,`f`),t??S(this,No,`f`));for(let e=2;e<S(this,G,`f`).length;e+=2)m.add({x:S(this,G,`f`)[e]*u+f,y:S(this,G,`f`)[e+1]*d+p});return m.getOutlines()}};jo=new WeakMap,Mo=new WeakMap,No=new WeakMap,Po=new WeakMap,G=new WeakMap,Fo=new WeakMap,K=new WeakMap,Ao=new WeakSet,Io=function(e,t,n,r,i){let a=new Float64Array(e.length);for(let o=0,s=e.length;o<s;o+=2)a[o]=t+e[o]*r,a[o+1]=n+e[o+1]*i;return a},Lo=function(e,t,n,r,i){let a=new Float64Array(e.length);for(let o=0,s=e.length;o<s;o+=2)a[o]=t+e[o+1]*r,a[o+1]=n+e[o]*i;return a},Ro=function(e){let t=S(this,K,`f`),n=t[4],r=t[5],i=n,a=r,o=n,s=r,c=n,l=r,u=e?Math.max:Math.min;for(let e=6,d=t.length;e<d;e+=6){if(isNaN(t[e]))i=Math.min(i,t[e+4]),a=Math.min(a,t[e+5]),o=Math.max(o,t[e+4]),s=Math.max(s,t[e+5]),l<t[e+5]?(c=t[e+4],l=t[e+5]):l===t[e+5]&&(c=u(c,t[e+4]));else{let d=yt.bezierBoundingBox(n,r,...t.slice(e,e+6));i=Math.min(i,d[0]),a=Math.min(a,d[1]),o=Math.max(o,d[2]),s=Math.max(s,d[3]),l<d[3]?(c=d[2],l=d[3]):l===d[3]&&(c=u(c,d[2]))}n=t[e+4],r=t[e+5]}let d=i-S(this,No,`f`),f=a-S(this,No,`f`),p=o-i+2*S(this,No,`f`),m=s-a+2*S(this,No,`f`);C(this,Mo,{x:d,y:f,width:p,height:m,lastPoint:[c,l]},`f`)};var q,J,Wo,Go,Ko,qo,Jo,Yo,Xo,Zo,Qo,Y,$o,es,ts,X,ns,rs,is,as,os,ss,cs,ls,us,ds,fs,ps,ms,hs,gs,_s,vs,ys=class extends P{constructor(e){super(Object.assign(Object.assign({},e),{name:`k-highlight-editor`})),q.add(this),this.color=``,Wo.set(this,null),Go.set(this,0),Ko.set(this,void 0),qo.set(this,null),Jo.set(this,null),Yo.set(this,null),Xo.set(this,0),Zo.set(this,null),Qo.set(this,null),Y.set(this,null),$o.set(this,!1),es.set(this,null),ts.set(this,void 0),X.set(this,null),ns.set(this,``),rs.set(this,void 0),is.set(this,``),this.color=e.color||J._defaultColor,C(this,rs,e.thickness||J._defaultThickness,`f`),C(this,ts,e.opacity||J._defaultOpacity,`f`),C(this,Ko,e.boxes||null,`f`),C(this,is,e.methodOfCreation||``,`f`),C(this,ns,e.text||``,`f`),this._isDraggable=!1,e.highlightId>-1?(C(this,$o,!0,`f`),S(this,q,`m`,os).call(this,e),S(this,q,`m`,us).call(this)):(C(this,Wo,e.anchorNode,`f`),C(this,Go,e.anchorOffset,`f`),C(this,Yo,e.focusNode,`f`),C(this,Xo,e.focusOffset,`f`),S(this,q,`m`,as).call(this),S(this,q,`m`,us).call(this),this.rotate(this.rotation))}get telemetryInitialData(){return{action:`added`,type:S(this,$o,`f`)?`free_highlight`:`highlight`,color:this._uiManager.highlightColorNames.get(this.color),thickness:S(this,rs,`f`),methodOfCreation:S(this,is,`f`)}}get telemetryFinalData(){return{type:`highlight`,color:this._uiManager.highlightColorNames.get(this.color)}}static computeTelemetryFinalData(e){return{numberOfColors:e.get(`color`).size}}static initialize(e,t){P.initialize(e,t,{}),J._defaultColor||=t.viewer?.options?.annotations?.highlight?.color||`#ffff00`}static updateDefaultParams(e,t){switch(e){case b.HIGHLIGHT_DEFAULT_COLOR:J._defaultColor=t;break;case b.HIGHLIGHT_THICKNESS:J._defaultThickness=t;break;default:break}}translateInPage(){}get toolbarPosition(){return S(this,es,`f`)}updateParams(e,t){switch(e){case b.HIGHLIGHT_COLOR:S(this,q,`m`,ss).call(this,t);break;case b.HIGHLIGHT_THICKNESS:S(this,q,`m`,cs).call(this,t);break;default:break}}static get defaultPropertiesToUpdate(){return[[b.HIGHLIGHT_DEFAULT_COLOR,J._defaultColor],[b.HIGHLIGHT_THICKNESS,J._defaultThickness]]}get propertiesToUpdate(){return[[b.HIGHLIGHT_COLOR,this.color||J._defaultColor],[b.HIGHLIGHT_THICKNESS,S(this,rs,`f`)||J._defaultThickness],[b.HIGHLIGHT_FREE,S(this,$o,`f`)]]}disableEditing(){super.disableEditing(),this.div.classList.toggle(`k-highlight-editor-disabled`,!0)}enableEditing(){super.enableEditing(),this.div.classList.toggle(`k-highlight-editor-disabled`,!1)}fixAndSetPosition(){return super.fixAndSetPosition(S(this,q,`m`,ms).call(this))}getBaseTranslation(){return[0,0]}getRect(e,t){return super.getRect(e,t,S(this,q,`m`,ms).call(this))}onceAdded(){this.parent.addUndoableEditor(this),this.div.focus()}remove(){S(this,q,`m`,ls).call(this),super.remove()}rebuild(){this.parent&&(super.rebuild(),this.div!==null&&(S(this,q,`m`,us).call(this),this.isAttachedToDOM||this.parent.add(this)))}setParent(e){let t=!1;this.parent&&!e?S(this,q,`m`,ls).call(this):e&&(S(this,q,`m`,us).call(this,e),t=!this.parent&&(this.div?.classList.contains(`selectedEditor`)||this.div?.classList.contains(`k-selected`))),super.setParent(e),this.show(this._isVisible),t&&this.select()}rotate(e){let{drawLayer:t}=this.parent,n;S(this,$o,`f`)?(e=(e-this.rotation+360)%360,n=S(J,J,`m`,ds).call(J,S(this,Qo,`f`).box,e)):n=S(J,J,`m`,ds).call(J,this,e),t.rotate(S(this,Y,`f`),e),t.rotate(S(this,X,`f`),e),t.updateBox(S(this,Y,`f`),n),t.updateBox(S(this,X,`f`),S(J,J,`m`,ds).call(J,S(this,Jo,`f`).box,e))}render(){if(this.div)return this.div;let e=super.render();S(this,ns,`f`)&&(e.setAttribute(`aria-label`,S(this,ns,`f`)),e.setAttribute(`role`,`mark`)),S(this,$o,`f`)?e.classList.add(`free`):this.div.addEventListener(`keydown`,S(this,q,`m`,fs).bind(this),{signal:this._uiManager._signal});let t=C(this,Zo,document.createElement(`div`),`f`);e.append(t),t.setAttribute(`aria-hidden`,`true`),t.className=`k-internal internal`,t.style.clipPath=S(this,qo,`f`);let[n,r]=this.parentDimensions;return this.setDims(this.width*n,this.height*r),Rr(this,S(this,Zo,`f`),[`pointerover`,`pointerleave`]),this.enableEditing(),e}pointerover(){this.parent.drawLayer.addClass(S(this,X,`f`),`hovered`)}pointerleave(){this.parent.drawLayer.removeClass(S(this,X,`f`),`hovered`)}_moveCaret(e){switch(this.parent.unselect(this),e){case 0:case 2:S(this,q,`m`,ps).call(this,!0);break;case 1:case 3:S(this,q,`m`,ps).call(this,!1);break;default:break}}select(){super.select(),S(this,X,`f`)&&(this.parent?.drawLayer.removeClass(S(this,X,`f`),`hovered`),this.parent?.drawLayer.addClass(S(this,X,`f`),`selected`),this.parent?.drawLayer.addClass(S(this,X,`f`),`k-selected`))}unselect(){super.unselect(),S(this,X,`f`)&&(this.parent?.drawLayer.removeClass(S(this,X,`f`),`selected`),this.parent?.drawLayer.removeClass(S(this,X,`f`),`k-selected`),S(this,$o,`f`)||S(this,q,`m`,ps).call(this,!1))}get _mustFixPosition(){return!S(this,$o,`f`)}show(e=this._isVisible){super.show(e),this.parent&&(this.parent.drawLayer.show(S(this,Y,`f`),e),this.parent.drawLayer.show(S(this,X,`f`),e))}static startHighlighting(e,t,{target:n,x:r,y:i}){let{x:a,y:o,width:s,height:c}=n.getBoundingClientRect(),l=new AbortController,u=e.combinedSignal(l),d=e=>{e.preventDefault(),e.stopPropagation()},f=t=>{l.abort(),S(this,J,`m`,vs).call(this,e,t)};window.addEventListener(`blur`,f,{signal:u}),window.addEventListener(`pointerup`,f,{signal:u}),window.addEventListener(`pointerdown`,d,{capture:!0,passive:!1,signal:u}),window.addEventListener(`contextmenu`,Et,{signal:u}),n.addEventListener(`pointermove`,S(this,J,`m`,_s).bind(this,e),{signal:u}),this._freeHighlight=new Ho({x:r,y:i},[a,o,s,c],e.scale,this._defaultThickness/2,t,.001),{id:this._freeHighlightId,clipPathId:this._freeHighlightClipId}=e.drawLayer.highlight(this._freeHighlight,this._defaultColor,this._defaultOpacity,!0)}static deserialize(e,t,n){let r=super.deserialize(e,t,n),{rect:[i,a,o,s],color:c,quadPoints:l}=e;r.color=yt.makeHexColor(...c),C(r,ts,e.opacity,`f`);let[u,d]=r.pageDimensions;r.width=(o-i)/u,r.height=(s-a)/d;let f=C(r,Ko,[],`f`);for(let e=0;e<l.length;e+=8)f.push({x:(l[4]-o)/u,y:(s-(1-l[e+5]))/d,width:(l[e+2]-l[e])/u,height:(l[e+5]-l[e+1])/d});return S(r,q,`m`,as).call(r),r}serialize(e=!1){if(this.isEmpty()||e)return null;let t=this.getRect(0,0),n=P._colorManager.convert(this.color);return{annotationType:y.HIGHLIGHT,color:n,opacity:S(this,ts,`f`),thickness:S(this,rs,`f`),quadPoints:S(this,q,`m`,hs).call(this),outlines:S(this,q,`m`,gs).call(this,t),pageIndex:this.pageIndex,rect:t,rotation:S(this,q,`m`,ms).call(this),structTreeParentId:this._structTreeParentId}}static canCreateNewEmptyEditor(){return!1}toJSON(){return this.serialize()}};J=ys,Wo=new WeakMap,Go=new WeakMap,Ko=new WeakMap,qo=new WeakMap,Jo=new WeakMap,Yo=new WeakMap,Xo=new WeakMap,Zo=new WeakMap,Qo=new WeakMap,Y=new WeakMap,$o=new WeakMap,es=new WeakMap,ts=new WeakMap,X=new WeakMap,ns=new WeakMap,rs=new WeakMap,is=new WeakMap,q=new WeakSet,as=function(){let e=new zo(S(this,Ko,`f`),.001);C(this,Qo,e.getOutlines(),`f`),{x:this.x,y:this.y,width:this.width,height:this.height}=S(this,Qo,`f`).box;let t=new zo(S(this,Ko,`f`),.0025,.001,this._uiManager.direction===`ltr`);C(this,Jo,t.getOutlines(),`f`);let{lastPoint:n}=S(this,Jo,`f`).box;C(this,es,[(n[0]-this.x)/this.width,(n[1]-this.y)/this.height],`f`)},os=function({highlightOutlines:e,highlightId:t,clipPathId:n}){if(C(this,Qo,e,`f`),C(this,Jo,e.getNewOutline(S(this,rs,`f`)/2+1.5,.0025),`f`),t>=0)C(this,Y,t,`f`),C(this,qo,n,`f`),this.parent.drawLayer.finalizeLine(t,e),C(this,X,this.parent.drawLayer.highlightOutline(S(this,Jo,`f`)),`f`);else if(this.parent){let t=this.parent.viewport.rotation;this.parent.drawLayer.updateLine(S(this,Y,`f`),e),this.parent.drawLayer.updateBox(S(this,Y,`f`),S(J,J,`m`,ds).call(J,S(this,Qo,`f`).box,(t-this.rotation+360)%360)),this.parent.drawLayer.updateLine(S(this,X,`f`),S(this,Jo,`f`)),this.parent.drawLayer.updateBox(S(this,X,`f`),S(J,J,`m`,ds).call(J,S(this,Jo,`f`).box,t))}let{x:r,y:i,width:a,height:o}=e.box;switch(this.rotation){case 0:this.x=r,this.y=i,this.width=a,this.height=o;break;case 90:{let[e,t]=this.parentDimensions;this.x=i,this.y=1-r,this.width=a*t/e,this.height=o*e/t;break}case 180:this.x=1-r,this.y=1-i,this.width=a,this.height=o;break;case 270:{let[e,t]=this.parentDimensions;this.x=1-i,this.y=r,this.width=a*t/e,this.height=o*e/t;break}default:break}let{lastPoint:s}=S(this,Jo,`f`).box;C(this,es,[(s[0]-r)/a,(s[1]-i)/o],`f`)},ss=function(e){if(!e)return;let t=e=>{this.color=e,this.parent?.drawLayer.changeColor(S(this,Y,`f`),e)},n=this.color;this.addCommands({cmd:t.bind(this,e),undo:t.bind(this,n),post:this._uiManager.updateUI.bind(this._uiManager,this),mustExec:!0,type:b.HIGHLIGHT_COLOR,overwriteIfSameType:!0,keepUndo:!0})},cs=function(e){},ls=function(){S(this,Y,`f`)===null||!this.parent||(this.parent.drawLayer.remove(S(this,Y,`f`)),C(this,Y,null,`f`),this.parent.drawLayer.remove(S(this,X,`f`)),C(this,X,null,`f`))},us=function(e=this.parent){var t,n;S(this,Y,`f`)===null&&(t=this,n=this,{id:{set value(e){C(t,Y,e,`f`)}}.value,clipPathId:{set value(e){C(n,qo,e,`f`)}}.value}=e.drawLayer.highlight(S(this,Qo,`f`),this.color,S(this,ts,`f`)),C(this,X,e.drawLayer.highlightOutline(S(this,Jo,`f`)),`f`),S(this,Zo,`f`)&&(S(this,Zo,`f`).style.clipPath=S(this,qo,`f`)))},ds=function({x:e,y:t,width:n,height:r},i){switch(i){case 90:return{x:1-t-r,y:e,width:r,height:n};case 180:return{x:1-e-n,y:1-t-r,width:n,height:r};case 270:return{x:t,y:1-e-n,width:r,height:n};default:break}return{x:e,y:t,width:n,height:r}},fs=function(e){},ps=function(e){if(!S(this,Wo,`f`))return;let t=window.getSelection();e?t.setPosition(S(this,Wo,`f`),S(this,Go,`f`)):t.setPosition(S(this,Yo,`f`),S(this,Xo,`f`))},ms=function(){return S(this,$o,`f`)?this.rotation:0},hs=function(){if(S(this,$o,`f`))return null;let[e,t]=this.pageDimensions,[n,r]=this.pageTranslation,i=S(this,Ko,`f`),a=new Float32Array(i.length*8),o=0;for(let{x:s,y:c,width:l,height:u}of i){let i=s*e+n,d=(1-c-u)*t+r;a[o]=a[o+4]=i,a[o+1]=a[o+3]=d,a[o+2]=a[o+6]=i+l*e,a[o+5]=a[o+7]=d+u*t,o+=8}return a},gs=function(e){return S(this,Qo,`f`).serialize(e,S(this,q,`m`,ms).call(this))},_s=function(e,t){this._freeHighlight.add(t)&&e.drawLayer.updatePath(this._freeHighlightId,this._freeHighlight)},vs=function(e,t){this._freeHighlight.isEmpty()?e.drawLayer.removeFreeHighlight(this._freeHighlightId):e.createAndAddNewEditor(t,!1,{highlightId:this._freeHighlightId,highlightOutlines:this._freeHighlight.getOutlines(),clipPathId:this._freeHighlightClipId,methodOfCreation:`main_toolbar`}),this._freeHighlightId=-1,this._freeHighlight=null,this._freeHighlightClipId=``},ys._defaultColor=null,ys._defaultOpacity=1,ys._defaultThickness=12,ys._type=`highlight`,ys._editorType=y.HIGHLIGHT,ys._freeHighlightId=-1,ys._freeHighlight=null,ys._freeHighlightClipId=``;var bs,Z,xs,Ss,Cs,ws,Ts,Es,Ds,Os,ks,As,js,Q,Ms,Ns,Ps,Fs,Is,Ls,Rs=class{constructor({uiManager:e,pageIndex:t,div:n,accessibilityManager:r,annotationLayer:i,drawLayer:a,textLayer:o,viewport:s}){bs.add(this),this.drawLayer=null,this.pageIndex=0,this.div=null,this.viewport=null,xs.set(this,void 0),Ss.set(this,!1),Cs.set(this,null),ws.set(this,null),Ts.set(this,null),Es.set(this,new Map),Ds.set(this,!1),Os.set(this,!1),ks.set(this,!1),As.set(this,null),js.set(this,null),Q.set(this,null);let c=[...S(Z,Z,`f`,Ms).values()];if(!Z._initialized){Z._initialized=!0;for(let t of c)t.initialize({},e)}e.registerEditorTypes(c),C(this,Q,e,`f`),this.pageIndex=t,this.div=n,C(this,xs,r,`f`),C(this,Cs,i,`f`),this.viewport=s,C(this,As,o,`f`),this.drawLayer=a,S(this,Q,`f`).addLayer(this)}hide(){this.div&&(this.div.hidden=!0)}show(){!this.div||this.isInvisible||(this.div.hidden=!1)}get isEmpty(){return S(this,Es,`f`).size===0}get isInvisible(){return this.isEmpty&&S(this,Q,`f`).getMode()===y.NONE}updateToolbar(){}updateMode(e=S(this,Q,`f`).getMode()){switch(S(this,bs,`m`,Ls).call(this),e){case y.NONE:this.disableTextSelection(),this.togglePointerEvents(!1),this.toggleAnnotationLayerPointerEvents(!0),this.disableClick();return;case y.INK:this.addInkEditorIfNeeded(!1),this.disableTextSelection(),this.togglePointerEvents(!0),this.disableClick();break;case y.HIGHLIGHT:this.enableTextSelection(),this.togglePointerEvents(!1),this.disableClick();break;default:this.disableTextSelection(),this.togglePointerEvents(!0),this.enableClick()}this.toggleAnnotationLayerPointerEvents(!1);let{classList:t}=this.div;for(let n of S(Z,Z,`f`,Ms).values())t.toggle(`${n._type}Editing`,e===n._editorType);this.div.hidden=!1}hasTextLayer(e){return e===S(this,As,`f`)?.div}addInkEditorIfNeeded(e){if(S(this,Q,`f`).getMode()===y.INK){if(!e){for(let e of S(this,Es,`f`).values())if(e.isEmpty()){e.setInBackground();return}}this.createAndAddNewEditor({offsetX:0,offsetY:0},!1).setInBackground()}}setEditingState(e){S(this,Q,`f`).setEditingState(e)}addCommands(e){S(this,Q,`f`).addCommands(e)}toggleDrawing(e=!1){this.div.classList.toggle(`drawing`,!e)}togglePointerEvents(e=!1){this.div.classList.toggle(`k-annotation-editor-layer-disabled`,!e)}toggleAnnotationLayerPointerEvents(e=!1){S(this,Cs,`f`)?.div.classList.toggle(`k-annotation-editor-layer-disabled`,!e)}enable(){this.div.tabIndex=0,this.togglePointerEvents(!0);let e=new Set;for(let t of S(this,Es,`f`).values())t.enableEditing(),t.show(!0),t.annotationElementId&&(S(this,Q,`f`).removeChangedExistingAnnotation(t),e.add(t.annotationElementId));if(!S(this,Cs,`f`))return;let t=S(this,Cs,`f`).getEditableAnnotations();for(let n of t){if(n.hide(),S(this,Q,`f`).isDeletedAnnotationElement(n.data.id)||e.has(n.data.id))continue;let t=this.deserialize(n);t&&(this.addOrRebuild(t),t.enableEditing())}}disable(){C(this,ks,!0,`f`),this.div.tabIndex=-1,this.togglePointerEvents(!1);let e=new Map,t=new Map;for(let n of S(this,Es,`f`).values())if(n.disableEditing(),n.annotationElementId){if(n.serialize()!==null){e.set(n.annotationElementId,n);continue}else t.set(n.annotationElementId,n);this.getEditableAnnotation(n.annotationElementId)?.show(),n.remove()}if(S(this,Cs,`f`)){let n=S(this,Cs,`f`).getEditableAnnotations();for(let r of n){let{id:n}=r.data;if(S(this,Q,`f`).isDeletedAnnotationElement(n))continue;let i=t.get(n);if(i){i.resetAnnotationElement(r),i.show(!1),r.show();continue}i=e.get(n),i&&(S(this,Q,`f`).addChangedExistingAnnotation(i),i.renderAnnotationElement(r),i.show(!1)),r.show()}}S(this,bs,`m`,Ls).call(this),this.isEmpty&&(this.div.hidden=!0);let{classList:n}=this.div;for(let e of S(Z,Z,`f`,Ms).values())n.remove(`${e._type}Editing`);this.disableTextSelection(),this.toggleAnnotationLayerPointerEvents(!0),C(this,ks,!1,`f`)}getEditableAnnotation(e){return S(this,Cs,`f`)?.getEditableAnnotation(e)||null}setActiveEditor(e){S(this,Q,`f`).getActive()!==e&&S(this,Q,`f`).setActiveEditor(e)}enableTextSelection(){if(this.div.tabIndex=-1,S(this,As,`f`)?.div&&!S(this,js,`f`)){C(this,js,new AbortController,`f`);let e=S(this,Q,`f`).combinedSignal(S(this,js,`f`));S(this,As,`f`).div.addEventListener(`pointerdown`,S(this,bs,`m`,Ns).bind(this),{signal:e})}}disableTextSelection(){this.div.tabIndex=0,S(this,As,`f`)?.div&&S(this,js,`f`)&&(S(this,js,`f`).abort(),C(this,js,null,`f`),S(this,As,`f`).div.classList.remove(`highlighting`))}enableClick(){if(S(this,ws,`f`))return;C(this,ws,new AbortController,`f`);let e=S(this,Q,`f`).combinedSignal(S(this,ws,`f`));this.div.addEventListener(`pointerdown`,this.pointerdown.bind(this),{signal:e}),this.div.addEventListener(`pointerup`,this.pointerup.bind(this),{signal:e})}disableClick(){S(this,ws,`f`)?.abort(),C(this,ws,null,`f`)}attach(e){S(this,Es,`f`).set(e.id,e);let{annotationElementId:t}=e;t&&S(this,Q,`f`).isDeletedAnnotationElement(t)&&S(this,Q,`f`).removeDeletedAnnotationElement(e)}detach(e){S(this,Es,`f`).delete(e.id),S(this,xs,`f`)?.removePointerInTextLayer(e.contentDiv),!S(this,ks,`f`)&&e.annotationElementId&&S(this,Q,`f`).addDeletedAnnotationElement(e)}remove(e){this.detach(e),S(this,Q,`f`).removeEditor(e),e.div.remove(),e.isAttachedToDOM=!1,S(this,Os,`f`)||this.addInkEditorIfNeeded(!1)}changeParent(e){e.parent!==this&&(e.parent&&e.annotationElementId&&(S(this,Q,`f`).addDeletedAnnotationElement(e.annotationElementId),P.deleteAnnotationElement(e),e.annotationElementId=null),this.attach(e),e.parent?.detach(e),e.setParent(this),e.div&&e.isAttachedToDOM&&(e.div.remove(),this.div.append(e.div)))}add(e){if(!(e.parent===this&&e.isAttachedToDOM)){if(this.changeParent(e),S(this,Q,`f`).addEditor(e),this.attach(e),!e.isAttachedToDOM){let t=e.render();this.div.append(t),e.isAttachedToDOM=!0}e.fixAndSetPosition(),e.onceAdded(),S(this,Q,`f`).addToAnnotationStorage(e)}}moveEditorInDOM(e){if(!e.isAttachedToDOM)return;let{activeElement:t}=document;e.div.contains(t)&&!S(this,Ts,`f`)&&(e._focusEventsAllowed=!1,C(this,Ts,setTimeout(()=>{C(this,Ts,null,`f`),e.div.contains(document.activeElement)?e._focusEventsAllowed=!0:(e.div.addEventListener(`focusin`,()=>{e._focusEventsAllowed=!0},{once:!0,signal:S(this,Q,`f`)._signal}),t.focus())},0),`f`)),e._structTreeParentId=S(this,xs,`f`)?.moveElementInDOM(this.div,e.div,e.contentDiv,!0)}addOrRebuild(e){e.needsToBeRebuilt()?(e.parent||=this,e.rebuild(),e.show()):this.add(e)}addUndoableEditor(e){this.addCommands({cmd:()=>e._uiManager.rebuild(e),undo:()=>{e.remove()},mustExec:!1})}getNextId(){return S(this,Q,`f`).getId()}combinedSignal(e){return S(this,Q,`f`).combinedSignal(e)}canCreateNewEmptyEditor(){return S(this,bs,`a`,Ps)?.canCreateNewEmptyEditor()}pasteEditor(e,t){S(this,Q,`f`).updateToolbar(e),S(this,Q,`f`).updateMode(e);let{offsetX:n,offsetY:r}=S(this,bs,`m`,Is).call(this),i=this.getNextId(),a=S(this,bs,`m`,Fs).call(this,Object.assign({parent:this,id:i,x:n,y:r,uiManager:S(this,Q,`f`),isCentered:!0},t));a&&this.add(a)}deserialize(e){return S(Z,Z,`f`,Ms).get(e.annotationType??e.annotationEditorType)?.deserialize(e,this,S(this,Q,`f`))||null}createAndAddNewEditor(e,t,n={}){let r=this.getNextId(),i=S(this,bs,`m`,Fs).call(this,Object.assign({parent:this,id:r,x:e.offsetX,y:e.offsetY,uiManager:S(this,Q,`f`),isCentered:t},n));return i&&this.add(i),i}addNewEditor(){this.createAndAddNewEditor(S(this,bs,`m`,Is).call(this),!0)}setSelected(e){S(this,Q,`f`).setSelected(e)}toggleSelected(e){S(this,Q,`f`).toggleSelected(e)}isSelected(e){return S(this,Q,`f`).isSelected(e)}unselect(e){S(this,Q,`f`).unselect(e)}pointerup(e){let{isMac:t}=mt.platform;if(!(e.button!==0||e.ctrlKey&&t)&&e.target===this.div&&S(this,Ds,`f`)){if(C(this,Ds,!1,`f`),!S(this,Ss,`f`)){C(this,Ss,!0,`f`);return}if(S(this,Q,`f`).getMode()===y.STAMP){S(this,Q,`f`).unselectAll();return}this.createAndAddNewEditor(e,!1)}}pointerdown(e){if(S(this,Q,`f`).getMode()===y.HIGHLIGHT&&this.enableTextSelection(),S(this,Ds,`f`)){C(this,Ds,!1,`f`);return}let{isMac:t}=mt.platform;if(e.button!==0||e.ctrlKey&&t||e.target!==this.div)return;C(this,Ds,!0,`f`);let n=S(this,Q,`f`).getActive();C(this,Ss,!n||n.isEmpty(),`f`)}findNewParent(e,t,n){let r=S(this,Q,`f`).findParent(t,n);return r===null||r===this?!1:(r.changeParent(e),!0)}destroy(){S(this,Q,`f`).getActive()?.parent===this&&(S(this,Q,`f`).commitOrRemove(),S(this,Q,`f`).setActiveEditor(null)),S(this,Ts,`f`)&&(clearTimeout(S(this,Ts,`f`)),C(this,Ts,null,`f`));for(let e of S(this,Es,`f`).values())S(this,xs,`f`)?.removePointerInTextLayer(e.contentDiv),e.setParent(null),e.isAttachedToDOM=!1,e.div.remove();this.div=null,S(this,Es,`f`).clear(),S(this,Q,`f`).removeLayer(this)}render({viewport:e}){this.viewport=e,ht(this.div,e);for(let e of S(this,Q,`f`).getEditors(this.pageIndex))this.add(e),e.rebuild();this.updateMode()}update({viewport:e}){S(this,Q,`f`).commitOrRemove(),S(this,bs,`m`,Ls).call(this);let t=this.viewport.rotation,n=e.rotation;if(this.viewport=e,ht(this.div,e),t!==n)for(let e of S(this,Es,`f`).values())e.rotate(n);this.addInkEditorIfNeeded(!1)}get pageDimensions(){let{pageWidth:e,pageHeight:t}=this.viewport.rawDims;return[e,t]}get scale(){return S(this,Q,`f`).viewParameters.realScale}};Z=Rs,xs=new WeakMap,Ss=new WeakMap,Cs=new WeakMap,ws=new WeakMap,Ts=new WeakMap,Es=new WeakMap,Ds=new WeakMap,Os=new WeakMap,ks=new WeakMap,As=new WeakMap,js=new WeakMap,Q=new WeakMap,bs=new WeakSet,Ns=function(e){S(this,Q,`f`).unselectAll();let{target:t}=e;if(t===S(this,As,`f`).div||t.classList.contains(`endOfContent`)&&S(this,As,`f`).div.contains(t)){let{isMac:t}=mt.platform;if(e.button!==0||e.ctrlKey&&t||(S(this,Q,`f`).showAllEditors(`highlight`,!0),S(this,Q,`f`).getMode()===y.NONE))return;S(this,As,`f`).div.addEventListener(`pointerup`,()=>{S(this,As,`f`).div.classList.remove(`free`),this.toggleDrawing(!0)},{once:!0,signal:S(this,Q,`f`)._signal}),e.preventDefault()}},Ps=function(){return S(Z,Z,`f`,Ms).get(S(this,Q,`f`).getMode())},Fs=function(e){let t=S(this,bs,`a`,Ps);return t?new t(e):null},Is=function(){let{x:e,y:t,width:n,height:r}=this.div.getBoundingClientRect(),i=Math.max(0,e),a=Math.max(0,t),o=Math.min(window.innerWidth,e+n),s=Math.min(window.innerHeight,t+r),c=(i+o)/2-e,l=(a+s)/2-t,[u,d]=this.viewport.rotation%180==0?[c,l]:[l,c];return{offsetX:u,offsetY:d}},Ls=function(){C(this,Os,!0,`f`);for(let e of S(this,Es,`f`).values())e.isEmpty()&&e.remove();C(this,Os,!1,`f`)},Rs._initialized=!1,Ms={value:new Map([$a,ys].map(e=>[e._editorType,e]))};var zs,Bs,Vs,Hs,Us,Ws=class{constructor(e){this.pdfPage=null,this.annotationEditorLayer=null,this._cancelled=null,this.div=null,this.accessibilityManager=null,zs.set(this,null),Bs.set(this,null),Vs.set(this,null),Hs.set(this,null),Us.set(this,null),this.pdfPage=e.pdfPage,this.accessibilityManager=e.accessibilityManager,this.annotationEditorLayer=null,this.div=null,this._cancelled=!1,C(this,Us,e.uiManager,`f`),C(this,zs,e.annotationLayer||null,`f`),C(this,Hs,e.textLayer||null,`f`),C(this,Bs,e.drawLayer||null,`f`),C(this,Vs,e.onAppend||null,`f`)}render(e){return x(this,arguments,void 0,function*(e,t=`display`){if(t!==`display`||this._cancelled)return;let n=e.clone({dontFlip:!0});if(this.div){this.annotationEditorLayer.update({viewport:n}),this.show();return}let r=this.div=document.createElement(`div`);r.className=`k-annotation-editor-layer`,r.hidden=!0,r.dir=S(this,Us,`f`).direction,S(this,Vs,`f`)?.call(this,r),this.annotationEditorLayer=new Rs({uiManager:S(this,Us,`f`),div:r,accessibilityManager:this.accessibilityManager,pageIndex:this.pdfPage.pageNumber-1,viewport:n,annotationLayer:S(this,zs,`f`),textLayer:S(this,Hs,`f`),drawLayer:S(this,Bs,`f`)});let i={viewport:n,div:r,annotations:null,intent:t};this.annotationEditorLayer.render(i),this.show()})}cancel(){this._cancelled=!0,this.div&&this.annotationEditorLayer?.destroy()}hide(){this.div&&(this.div.hidden=!0)}show(){!this.div||this.annotationEditorLayer.isInvisible||(this.div.hidden=!1)}destroy(){this.annotationEditorLayer?.destroy()}};zs=new WeakMap,Bs=new WeakMap,Vs=new WeakMap,Hs=new WeakMap,Us=new WeakMap;var $,Gs,Ks,qs,Js,Ys,Xs,Zs,Qs,$s,ec,tc,nc,rc,ic,ac,oc;let sc={annotationEditorUIManager:null,annotationStorage:null,downloadManager:null,enableScripting:!1,fieldObjectsPromise:null,findController:null,hasJSActionsPromise:null,get linkService(){return null}},cc=new Map([[`canvasWrapper`,0],[`textLayer`,1],[`annotationLayer`,2],[`annotationEditorLayer`,3],[`xfaLayer`,3]]);var lc=class extends Me{constructor(e,t){super(e,t),$.add(this),this.eventBus=null,this.zoomLayer=null,this.div=null,this.viewport=null,this.id=1,this._accessibilityManager=null,this._annotationCanvasMap=new Map,this.renderTask=null,this.pdfPageRotate=null,this.rotation=null,this.scale=null,this.pdfViewer=null,this.xfaLayer=null,Gs.set(this,St.ENABLE),Ks.set(this,!1),qs.set(this,null),Js.set(this,null),Ys.set(this,sr.INITIAL),Xs.set(this,lr.ENABLE),Zs.set(this,new WeakMap),Qs.set(this,[null,null,null,null]),this.textLayer=null,this.textLayerBuilder=null,this.textAccessibilityManager=null,this.annotationLayer=null,this.drawLayer=null,this.annotationEditorLayer=null,this.options={},this.state={},this.pdfPage=null,this.extendOptions(t),this.div=e,this.viewport=this.options.viewport,this.id=this.options.id||this.options.number||1,C(this,qs,t.layerProperties||sc,`f`),this.eventBus=t.eventBus,this.initScale(),this.pdfViewer=t.pdfViewer,this.pdfPage=t.pdfPage,C(this,Gs,this.pdfViewer.getAnnotationMode(),`f`),this.resetState()}destroy(){this.destroyTextLayer(),this.canvas&&=(this.canvas.width=0,this.canvas.height=0,this.canvas.remove(),null),this.canvasForPrint&&=(this.canvasForPrint.width=0,this.canvasForPrint.height=0,this.canvasForPrint.remove(),null),this.drawLayer?.destroy(),this.annotationLayer?.destroy(),this.annotationEditorLayer?.destroy(),this.div?.remove(),this.div=null,this.pdfViewer=null,this.pdfPage?.cleanup(),this.pdfPage=null}get isEditing(){return S(this,Ks,`f`)}get rawWidth(){return this.viewport?.rawDims?.pageWidth}get rawHeight(){return this.viewport?.rawDims?.pageWidth}setState(e){this.state=be(this.state||{},e)}resetState(){this.setState({})}initScale(){this.scale=this.options.zoomLevel||this.options.scale||1}createPromise(){return je()}getViewport(e={scale:1}){return this.pdfPage?this.pdfPage.getViewport(e):{width:0,height:0}}destroyTextLayer(){this.textLayer?.cancel(),this.textLayer?.destroy(),this.removeTextLayer(),this.textLayer=null}removeTextLayer(){this.textLayer&&this.textLayer.div?.parentNode&&this.textLayer.div?.parentNode.removeChild(this.textLayer.div)}getPrintContentAsync(){let e=this.canvasForPrint,t=this.createPromise(),n=new Image,r=e.height/this.pdfViewer.getPrintScale()*this.pdfViewer.getPdfToCssUnits(),i=e.width/this.pdfViewer.getPrintScale()*this.pdfViewer.getPdfToCssUnits();return n.src=e.toDataURL(),n.width=i,n.height=r,n.onload=()=>{t.resolve(n)},t}loadForPrintAsync({zoomLevel:e=1.25,force:t=!1}){let n=this,r=this.createPromise(),i=this.pdfViewer.state.zoomLevel;if(this.pdfPage&&i===e&&!t)return r.resolve(n);if(this.pdfPage&&i&&(i!==e||t))return this.renderForPrintAsync().then(()=>{this.setState({isPrintingInProgress:!1}),r.resolve(n)}),r;let a=Math.max(0,this.pdfPage._pageIndex);return this.pdfViewer.state.pdfDocument.getPage(a+1).then(()=>{this.renderForPrintAsync().then(()=>{this.setState({isPrintingInProgress:!1}),r.resolve(n)})}),r}renderForPrintAsync(){let e=this.pdfViewer.getPrintUnits(),{canvasContext:t,canvas:n,viewport:r}=this.pdfViewer.createPageElements({pdfPage:this.pdfPage,printUnits:e});this.canvasForPrint=n,this.setState({isPrintingInProgress:!0});let i=this.pdfViewer.state.pdfDocument.getOptionalContentConfig({intent:`print`}),a={canvasContext:t,viewport:r,intent:`print`,annotationMode:St.ENABLE_STORAGE,optionalContentConfigPromise:i,printAnnotationStorage:this.pdfViewer?.annotationStorage?.print};return this.pdfPage.render(a).promise}isBlank(){return this.element&&this.element.getAttribute(`data-blank`)}setBlank(e){this.element&&(e?this.element.setAttribute(`data-blank`,`true`):this.element.removeAttribute(`data-blank`))}get renderingState(){return S(this,Ys,`f`)}setPdfPage(e){this.pdfPage=e,this.pdfPageRotate=e.rotate;let t=(this.rotation+this.pdfPageRotate)%360;this.viewport=e.getViewport({scale:this.scale*gt.PDF_TO_CSS_UNITS,rotation:t}),S(this,$,`m`,ec).call(this),this.reset()}hasEditableAnnotations(){return!!this.annotationLayer?.hasEditableAnnotations()}_resetZoomLayer(e=!1){if(!this.zoomLayer)return;let t=this.zoomLayer.firstChild;S(this,Zs,`f`).delete(t),t.width=0,t.height=0,e&&this.zoomLayer.remove(),this.zoomLayer=null}reset({keepZoomLayer:e=!1,keepAnnotationLayer:t=!1,keepAnnotationEditorLayer:n=!1,keepXfaLayer:r=!1,keepTextLayer:i=!1}={}){let a=this.div;if(!a)return;let o=a.childNodes,s=e&&this.zoomLayer||null,c=t&&this.annotationLayer?.div||null,l=n&&this.annotationEditorLayer?.div||null,u=r&&this.xfaLayer?.div||null,d=i&&this.textLayer?.div||null;for(let e=o.length-1;e>=0;e--){let t=o[e];switch(t){case s:case c:case l:case u:case d:continue;default:break}t.remove();let n=S(this,Qs,`f`).indexOf(t);n>=0&&(S(this,Qs,`f`)[n]=null)}a.removeAttribute(`data-loaded`),c&&this.annotationLayer?.hide(),l&&this.annotationEditorLayer?.hide(),u&&this.xfaLayer?.hide(),d&&this.textLayer?.hide(),s||(this.canvas&&(S(this,Zs,`f`).delete(this.canvas),this.canvas.width=0,this.canvas.height=0,delete this.canvas),this._resetZoomLayer())}toggleEditingMode(e){this.hasEditableAnnotations()&&(C(this,Ks,e,`f`),this.reset({keepZoomLayer:!0,keepAnnotationLayer:!0,keepAnnotationEditorLayer:!0,keepXfaLayer:!0,keepTextLayer:!0}))}draw(){return x(this,void 0,void 0,function*(){let{canvasContext:e,canvas:t,canvasWrapper:n,viewport:r,pageElement:i,styles:a}=this.pdfViewer.createPageElements({pdfPage:this.pdfPage,zoom:this.pdfViewer.options.zoomLevel||1});this.isBlank()?(this.element.replaceWith(i),this.element=this.div=i,this.canvas=t):(this.element=this.div=this.element||this.div||i,this.canvas=this.canvas||t),this.options.styles=a,n.appendChild(t),this.element.appendChild(n),S(this,$,`m`,$s).call(this,n,`canvasWrapper`);let{div:o,pdfPage:s}=this;if(!this.textLayer&&S(this,Xs,`f`)!==lr.DISABLE&&!s.isPureXfa&&(this._accessibilityManager||=new Sr,this.textLayer=new jr({styles:this.options.styles,pdfPage:s,accessibilityManager:this._accessibilityManager,onAppend:e=>{S(this,$,`m`,$s).call(this,e,`textLayer`)}})),!this.annotationLayer&&S(this,Gs,`f`)!==St.DISABLE){let{annotationStorage:e,annotationEditorUIManager:t,linkService:n}=S(this,qs,`f`);this._annotationCanvasMap||=new Map,this.annotationLayer=new Oa({pdfPage:s,eventBus:this.eventBus||this.pdfViewer.eventBus,annotationStorage:e,renderForms:S(this,Gs,`f`)===St.ENABLE_FORMS,linkService:n,annotationCanvasMap:this._annotationCanvasMap,accessibilityManager:this._accessibilityManager,annotationEditorUIManager:t,onAppend:e=>{S(this,$,`m`,$s).call(this,e,`annotationLayer`)}})}S(this,Zs,`f`).set(t,r);let c={canvasContext:e,viewport:r,annotationMode:S(this,Gs,`f`),annotationCanvasMap:this._annotationCanvasMap,isEditing:S(this,Ks,`f`)},l=this.renderTask=s.render(c),u=l.promise.then(()=>x(this,void 0,void 0,function*(){yield S(this,$,`m`,oc).call(this,l),yield S(this,$,`m`,ac).call(this),this.annotationLayer&&(yield S(this,$,`m`,nc).call(this));let{annotationEditorUIManager:e}=S(this,qs,`f`);e&&(this.drawLayer||=new Ra({pageIndex:this.id}),yield S(this,$,`m`,ic).call(this),this.drawLayer.setParent(n),this.annotationEditorLayer||=new Ws({uiManager:e,pdfPage:s,accessibilityManager:this._accessibilityManager,annotationLayer:this.annotationLayer?.annotationLayer,textLayer:this.textLayer,drawLayer:this.drawLayer.getDrawLayer(),onAppend:e=>{S(this,$,`m`,$s).call(this,e,`annotationEditorLayer`)}}),S(this,$,`m`,rc).call(this))}),e=>{});return s.isPureXfa,o.setAttribute(`data-loaded`,!0),this.eventBus.dispatch(`pagerender`,{source:this,pageNumber:this.id}),u})}};Gs=new WeakMap,Ks=new WeakMap,qs=new WeakMap,Js=new WeakMap,Ys=new WeakMap,Xs=new WeakMap,Zs=new WeakMap,Qs=new WeakMap,$=new WeakSet,$s=function(e,t){let n=cc.get(t),r=S(this,Qs,`f`)[n];if(S(this,Qs,`f`)[n]=e,r){r.replaceWith(e);return}for(let t=n-1;t>=0;t--){let n=S(this,Qs,`f`)[t];if(n){n.after(e);return}}this.div.prepend(e)},ec=function(){let{viewport:e}=this;if(this.pdfPage){if(S(this,Js,`f`)===e.rotation)return;C(this,Js,e.rotation,`f`)}!this.div||!e||ht(this.div,e,!0,!1)},tc=function(e,t){this.eventBus.dispatch(e,{source:this,pageNumber:this.id,error:t})},nc=function(){return x(this,void 0,void 0,function*(){let e=null;try{yield this.annotationLayer.render(this.viewport,`display`)}catch(t){console.error(`#renderAnnotationLayer: "${t}".`),e=t}finally{S(this,$,`m`,tc).call(this,`annotationlayerrendered`,e)}})},rc=function(){return x(this,void 0,void 0,function*(){let e=null;try{yield this.annotationEditorLayer.render(this.viewport)}catch(t){e=t}finally{S(this,$,`m`,tc).call(this,`annotationeditorlayerrendered`,e)}})},ic=function(){return x(this,void 0,void 0,function*(){try{yield this.drawLayer.render(`display`)}catch{}})},ac=function(){return x(this,void 0,void 0,function*(){if(!this.textLayer)return;let e=null;try{yield this.textLayer.render(this.viewport)}catch(t){if(t instanceof Ct)return;e=t}S(this,$,`m`,tc).call(this,`textlayerrendered`,e)})},oc=function(e){return x(this,void 0,void 0,function*(){e===this.renderTask&&(this.renderTask=null),this._resetZoomLayer(!0),this.eventBus.dispatch(`pagerendered`,{source:this,pageNumber:this.id,cssTransform:!1,timestamp:performance.now(),error:`page render error`})})};var uc,dc;let fc={NONE:0,SELF:1,BLANK:2,PARENT:3,TOP:4};var pc=class{constructor({eventBus:e=null,externalLinkTarget:t=null,externalLinkRel:n=null,ignoreDestinationZoom:r=!1}={}){this.eventBus=null,this.externalLinkTarget=null,this.externalLinkRel=null,this._ignoreDestinationZoom=null,this.baseUrl=null,this.pdfDocument=null,this.pdfViewer=null,this.pdfHistory=null,this.externalLinkEnabled=!0,this.eventBus=e,this.externalLinkTarget=t,this.externalLinkRel=n,this._ignoreDestinationZoom=r,this.baseUrl=null,this.pdfDocument=null,this.pdfViewer=null,this.pdfHistory=null}setDocument(e,t=null){this.baseUrl=t,this.pdfDocument=e}setViewer(e){this.pdfViewer=e}setHistory(e){this.pdfHistory=e}get pagesCount(){return this.pdfDocument?this.pdfDocument.numPages:0}get page(){return this.pdfDocument?this.pdfViewer.currentPageNumber:1}set page(e){this.pdfDocument&&(this.pdfViewer.currentPageNumber=e)}get rotation(){return this.pdfDocument?this.pdfViewer.pagesRotation:0}set rotation(e){this.pdfDocument&&(this.pdfViewer.pagesRotation=e)}get isInPresentationMode(){return this.pdfDocument?this.pdfViewer.isInPresentationMode:!1}goToDestination(e){return x(this,void 0,void 0,function*(){if(!this.pdfDocument)return;let t,n,r;if(typeof e==`string`?(t=e,n=yield this.pdfDocument.getDestination(e)):(t=null,n=yield e),!Array.isArray(n))return;let[i]=n;if(i&&typeof i==`object`){if(r=this.pdfDocument.cachedPageNumber(i),!r)try{r=(yield this.pdfDocument.getPageIndex(i))+1}catch{console.error(`goToDestination: "${i}" is not a valid page reference, for dest="${e}".`);return}}else Number.isInteger(i)&&(r=i+1);if(!r||r<1||r>this.pagesCount){console.error(`goToDestination: "${r}" is not a valid page number, for dest="${e}".`);return}this.pdfHistory&&(this.pdfHistory.pushCurrentPosition(),this.pdfHistory.push({namedDest:t,explicitDest:n,pageNumber:r})),this.pdfViewer.scrollPageIntoView({pageNumber:r,destArray:n,ignoreDestinationZoom:this._ignoreDestinationZoom})})}goToPage(e){if(!this.pdfDocument)return;let t=typeof e==`string`&&this.pdfViewer.pageLabelToPageNumber(e)||e|0;if(!(Number.isInteger(t)&&t>0&&t<=this.pagesCount)){console.error(`PDFLinkService.goToPage: "${e}" is not a valid page.`);return}this.pdfHistory&&(this.pdfHistory.pushCurrentPosition(),this.pdfHistory.pushPage(t)),this.pdfViewer.scrollPageIntoView({pageNumber:t})}addLinkAttributes(e,t,n=!1){if(!t||typeof t!=`string`)throw Error(`A valid "url" parameter must provided.`);let r=n?fc.BLANK:this.externalLinkTarget,i=this.externalLinkRel;this.externalLinkEnabled?e.href=e.title=t:(e.href=``,e.title=`Disabled: ${t}`,e.onclick=()=>!1);let a=``;switch(r){case fc.NONE:break;case fc.SELF:a=`_self`;break;case fc.BLANK:a=`_blank`;break;case fc.PARENT:a=`_parent`;break;case fc.TOP:a=`_top`;break;default:break}e.target=a,e.rel=typeof i==`string`?i:`noopener noreferrer nofollow`}getDestinationHash(e){if(typeof e==`string`){if(e.length>0)return this.getAnchorUrl(`#`+escape(e))}else if(Array.isArray(e)){let t=JSON.stringify(e);if(t.length>0)return this.getAnchorUrl(`#`+escape(t))}return this.getAnchorUrl(``)}getAnchorUrl(e){return this.baseUrl?this.baseUrl+e:e}setHash(e){if(!this.pdfDocument)return;let t,n;if(e.includes(`=`)){let r=fr(e);if(r.has(`search`)){let e=r.get(`search`).replaceAll(`"`,``),t=r.get(`phrase`)===`true`;this.eventBus.dispatch(`findfromurlhash`,{source:this,query:t?e:e.match(/\S+/g)})}if(r.has(`page`)&&(t=r.get(`page`)|0||1),r.has(`zoom`)){let e=r.get(`zoom`).split(`,`),t=e[0],i=parseFloat(t);t.includes(`Fit`)?t===`Fit`||t===`FitB`?n=[null,{name:t}]:t===`FitH`||t===`FitBH`||t===`FitV`||t===`FitBV`?n=[null,{name:t},e.length>1?e[1]|0:null]:t===`FitR`?e.length===5?n=[null,{name:t},e[1]|0,e[2]|0,e[3]|0,e[4]|0]:console.error(`PDFLinkService.setHash: Not enough parameters for "FitR".`):console.error(`PDFLinkService.setHash: "${t}" is not a valid zoom value.`):n=[null,{name:`XYZ`},e.length>1?e[1]|0:null,e.length>2?e[2]|0:null,i?i/100:t]}n?this.pdfViewer.scrollPageIntoView({pageNumber:t||this.page,destArray:n,allowNegativeOffset:!0}):t&&(this.page=t),r.has(`pagemode`)&&this.eventBus.dispatch(`pagemode`,{source:this,mode:r.get(`pagemode`)}),r.has(`nameddest`)&&this.goToDestination(r.get(`nameddest`));return}n=unescape(e);try{n=JSON.parse(n),Array.isArray(n)||(n=n.toString())}catch(e){if(!e)return}(typeof n==`string`||S(uc,uc,`m`,dc).call(uc,n))&&this.goToDestination(n)}executeNamedAction(e){if(this.pdfDocument){switch(e){case`GoBack`:this.pdfHistory?.back();break;case`GoForward`:this.pdfHistory?.forward();break;case`NextPage`:this.pdfViewer.nextPage();break;case`PrevPage`:this.pdfViewer.previousPage();break;case`LastPage`:this.page=this.pagesCount;break;case`FirstPage`:this.page=1;break;default:break}this.eventBus.dispatch(`namedaction`,{source:this,action:e})}}executeSetOCGState(e){return x(this,void 0,void 0,function*(){if(!this.pdfDocument)return;let t=this.pdfDocument,n=yield this.pdfViewer.optionalContentConfigPromise;t===this.pdfDocument&&(n.setOCGState(e),this.pdfViewer.optionalContentConfigPromise=Promise.resolve(n))})}};uc=pc,dc=function(e){if(!Array.isArray(e)||e.length<2)return!1;let[t,n,...r]=e;if(!(typeof t==`object`&&Number.isInteger(t?.num)&&Number.isInteger(t?.gen))&&!Number.isInteger(t)||!(typeof n==`object`&&typeof n?.name==`string`))return!1;let i=r.length,a=!0;switch(n.name){case`XYZ`:if(i<2||i>3)return!1;break;case`Fit`:case`FitB`:return i===0;case`FitH`:case`FitBH`:case`FitV`:case`FitBV`:if(i>1)return!1;break;case`FitR`:if(i!==4)return!1;a=!1;break;default:return!1}for(let e of r)if(!(typeof e==`number`||a&&e===null))return!1;return!0};var mc;(function(e){e[e.TextSelection=0]=`TextSelection`,e[e.Pan=1]=`Pan`})(mc||={});var hc,gc,_c,vc,yc,bc,xc,Sc;let Cc=`error`,wc=`zoomStart`,Tc=`zoomEnd`,Ec=`pageRendered`,Dc=`pagesLoad`,Oc=`printEnd`,kc=`scroll`,Ac=`annotationEditorToolBarShow`,jc=`annotationEditorToolBarHide`,Mc=1.25;var Nc=class extends Me{constructor(e,t){super(e,t),hc.add(this),this.options={pdfServiceType:`pdfjs`,pdfjsSetHiddenCanvasStyles:!0,fileData:[],page:1,fileDescriptor:null,downloadFileName:`Document`,minZoom:.5,maxZoom:4,zoomRate:.25,zoomLevel:Mc,zoomBeforePrint:!1,zoomLevelForPrint:3,renderForms:!1,searchMatchScrollLeftOffset:0,searchMatchScrollTopOffset:-64,pageChangeScrollThreshold:.85,pageWheelThrottleDelay:200,printScale:3,renderScale:3,loadOnDemand:!1,loadOnDemandPageSize:2,messages:{freeTextEditorPlaceholder:`Start typing`,errorMessages:{parseError:`PDF file fails to process.`,notFound:`File is not found.`,popupBlocked:`Popup is blocked.`}},annotations:{highlight:{color:`#ffff00`}},elementSelectors:{pageSelector:`k-page:not(.k-blank-page)`,anyPageSelector:`k-page`,pagesContainerClass:`k-pdf-viewer-pages`,pageCanvasWrapper:`k-canvas-wrapper`,documentContainerClass:`k-pdf-viewer-canvas`,textLayerClass:`k-text-layer`,searchHighlightClass:`k-search-highlight`,searchHighlightMarkClass:`k-search-highlight-mark`,charClass:`k-text-char`,textElementSelector:`span[role='presentation']`,renderedPageSelector:`k-page[data-page-number]`,enabledTextSelectionClass:`k-enable-text-select`,enabledPanningClass:`k-enable-panning`},events:{[Ec]:De,[Dc]:De,[Oc]:De,[wc]:De,[Tc]:De,[Cc]:De,[kc]:De,[Ac]:De,[jc]:De}},this.interactionMode=mc.TextSelection,this.printContainer=null,this._scrollMode=ur.PAGE,this.isInPresentationMode=!1,this._currentPageNumber=1,this.linkService=null,this.annotationStorage=null,this._annotationStorageModified=!1,this._hasAnnotationEditors=!1,gc.set(this,y.NONE),this.annotationEditorUIManager=null,_c.set(this,null),vc.set(this,Xt.ENABLE),yc.set(this,null),bc.set(this,null),this.state={},this.pdfDocument=null,this.pages=[],this.triggerError=e=>{this.trigger(Cc,{error:e})},this.triggerPrintEnd=e=>{this.trigger(Oc,e)},this.onPagesLoad=e=>{this.state.pdfDocument=e.pdfDoc,this.state.pdfPages=e.pdfPages,this.clearSearch(),this.initSearchService(),this.enableDocumentScrollEventsTracking(),this.triggerPagesLoad(e)},this.onDocumentScrollerScroll=e=>{let t=this.getCurrentPageIndex(),n=this.pages,r=n[t],i=n[t+1],a=n[t-1];r&&r.isBlank()&&this.drawPageAsync({pageIndex:t}),i&&i.isBlank()&&this.drawPageAsync({pageIndex:t+1}),a&&a.isBlank()&&this.drawPageAsync({pageIndex:t-1}),this.tryTriggerScroll(e)},this.tryTriggerScroll=e=>{let t=!1,n=this.getCurrentPageIndex()+1;n!==this.state.activePageNumber&&n>=1&&n<=this.state.pdfDocument.numPages&&(t=!0,this.state.activePageNumber=n),this.shouldPreventScroll?this.shouldPreventScroll=!1:this.trigger(kc,{scrollLeft:e.scrollLeft,scrollTop:e.scrollTop,pageNumber:this.state.activePageNumber,isPageChanged:t})},this.printDocumentAsync=()=>{this.initPrintContainer();let e=this.getPagesPrintContentAsync(this.printContainer),t=je();return Promise.all(e).then(()=>{setTimeout(()=>{this.openPrintDialog(),t.resolve()},16.666666666666668)}),t},this.onDocumentWheel=e=>{if(!e.ctrlKey&&!e.metaKey)return;e.preventDefault(),e.stopPropagation();let t=Ae(e)<0?1:-1,n=this.state.zoomLevel+t*this.options.zoomRate;this.triggerZoomStart({zoomLevel:n}),this.zoom({zoomLevel:n}),this.triggerZoomEnd({zoomLevel:n})},this.extendOptions(t),this.throwIfInvalidOptions(),this.wrapper=this.element,this.initEventBus(),C(this,yc,new AbortController,`f`),this.options.renderForms&&C(this,vc,Xt.ENABLE_FORMS,`f`),this.resetState(),this.bindEvents(),this.initLinkService(),this.initDocumentContainer(),this.setHiddenCanvasStyles(),this.loadFile(this.options.fileDescriptor||{data:this.options.fileData,page:this.options.page})}destroy(){this.destroyEventBus(),this.unbindEvents(),this.clearDocument(),this.destroySearchService(),this.destroyAnnotationEditorUIManager(),this.destroyDocumentScroller()}throwIfInvalidOptions(){if(this.options.minZoom>this.options.maxZoom)throw Error(`The min zoom should be greater than max zoom`)}set annotationEditorParams({type:e,value:t}){this.annotationEditorUIManager&&this.annotationEditorUIManager.updateParams(e,t)}get annotationEditorMode(){return this.annotationEditorUIManager?S(this,gc,`f`):y.DISABLE}set annotationEditorMode({mode:e,editId:t=null,isFromKeyboard:n=!1}){if(this.annotationEditorUIManager,S(this,gc,`f`)===e||!this.isValidAnnotationEditorMode(e)||!this.pdfDocument)return;y.STAMP;let{eventBus:r}=this,i=()=>{this.cleanupSwitchAnnotationEditorMode(),C(this,gc,e,`f`),this.annotationEditorUIManager.updateMode(e,t,n),r.dispatch(`annotationeditormodechanged`,{source:this,mode:e})};if(e===y.NONE||S(this,gc,`f`)===y.NONE){let t=e!==y.NONE;t||this.pdfDocument.annotationStorage.resetModifiedIds();for(let e of this.pages)e.toggleEditingMode(t);let n=S(this,hc,`m`,xc).call(this);if(t&&n){this.cleanupSwitchAnnotationEditorMode(),C(this,bc,({pageNumber:e})=>{n.delete(e),n.size===0&&C(this,_c,setTimeout(i,0),`f`)},`f`);let{signal:e}=S(this,yc,`f`);r._on(`pagerendered`,S(this,bc,`f`),{signal:e})}}i()}getAnnotationMode(){return S(this,vc,`f`)}getPrintUnits(){return this.getPrintScale()}getPdfToCssUnits(){return gt.PDF_TO_CSS_UNITS}getPrintScale(){return this.getPrintResolution()/gt.PDF}getPrintResolution(){return 100*this.options.printScale}getRenderScale(){return Ft(this.options.renderScale)}extendOptions(e){this.options=be(this.options,e)}setOptions(e){this.options=e}bindEvents(){this.bindPagesWheel()}bindPagesWheel(){let e=this.getDocumentContainer();e&&(this.options.pageWheelThrottleDelay>0?this.throttledPagesWheel=Ne(this.onDocumentWheel,this.options.pageWheelThrottleDelay):this.throttledPagesWheel=this.onDocumentWheel,e.addEventListener(`wheel`,this.throttledPagesWheel))}unbindEvents(){this.unbindPagesWheel()}unbindPagesWheel(){let e=this.getDocumentContainer();e&&(this.throttledPagesWheel&&this.throttledPagesWheel.cancel&&this.throttledPagesWheel.cancel(),e.removeEventListener(`wheel`,this.throttledPagesWheel))}setState(e){this.state=be(this.state||{},e)}resetState(){this.setState({activePageNumber:1,visiblePagesCount:1,pagePromises:[],downloadFilePromise:null,pdfDocument:null,zoomLevel:this.options.zoomLevel,zoomLevelType:this.options.zoomLevelType,zoomLevelBeforePrint:null})}initEventBus(){this.eventBus=new or}destroyEventBus(){}initLinkService(){this.linkService=new pc({eventBus:this.eventBus,externalLinkTarget:fc.BLANK,externalLinkRel:`noopener noreferrer nofollow`,ignoreDestinationZoom:!1}),this.linkService?.setViewer(this)}initAnnotationEditorUIManager(){this.annotationEditorUIManager=new ir({container:this.getDocumentContainer(),viewer:this.element,pdfViewer:this,pdfDocument:this.state.pdfDocument,eventBus:this.eventBus}),this.setAnnotationEditorUIManagerScale()}setAnnotationEditorUIManagerScale(){this.annotationEditorUIManager?.onScaleChanging({scale:this.options.zoomLevel})}destroyAnnotationEditorUIManager(){this.annotationEditorUIManager?.destroy(),this.annotationEditorUIManager=null}bindEventBusAnnotationsEvents(){let e=this.eventBus=this.eventBus||new or;e._on(`switchannotationeditorparams`,e=>{this.annotationEditorParams=e}),e._on(`switchannotationeditormode`,t=>{this.annotationEditorUIManager.updateParams(t.type,t.value);let{mode:n,editId:r,isFromKeyboard:i}=t;this.annotationEditorUIManager.annotationEditorMode=t,this.annotationEditorUIManager.updateMode(n,r,i),e.dispatch(`annotationeditormodechanged`,{source:this,mode:n})}),e._on(`kendoAnnotationEditorToolBarShow`,e=>{if(!e)return;let t=this.annotationEditorUIManager.getMode();(t===y.HIGHLIGHT||t===y.FREETEXT)&&(t===y.HIGHLIGHT&&this.addHighlightAnnotation(),this.triggerAnnotationEditorToolBarShow(Object.assign(Object.assign({},e),{annotationEditorMode:t===y.HIGHLIGHT?`highlight`:`freeText`,anchor:e.anchor||this.annotationEditorUIManager.firstSelectedEditor?.div})))}),e._on(`kendoAnnotationEditorToolBarHide`,e=>{if(!e)return;let t=this.annotationEditorUIManager.getMode();(t===y.HIGHLIGHT||t===y.FREETEXT)&&this.triggerAnnotationEditorToolBarHide(Object.assign(Object.assign({},e),{annotationEditorMode:t===y.HIGHLIGHT?`highlight`:`freeText`}))}),e._on(`showannotationeditorui`,t=>{switch(t.mode){case y.HIGHLIGHT:e.dispatch(`switchannotationeditormode`,{source:this,mode:y.HIGHLIGHT,isFromKeyboard:!1});break;default:break}})}unbindEventBusAnnotationsEvents(){}loadFile(e){let t=e.data,n={data:null,url:``,arrayBuffer:null,typedArray:null};if(t&&(t.buffer instanceof ArrayBuffer||t instanceof ArrayBuffer)?n.arrayBuffer=t.buffer||t:Se(t)&&t!==``?(n.data=t,n.url=null):Se(e.url)&&e.url!==``?(n.data=null,n.url=e.url):e.typedArray&&(n.typedArray=e.typedArray),e.data||e.url||e.arrayBuffer||e.typedArray){let e=Object.assign({dom:this.getPagesContainer(),zoom:this.options.zoomLevel},n);this.disableDocumentScrollEventsTracking(),this.clearDocument(),this.initEventBus(),C(this,yc,new AbortController,`f`),this.bindEvents(),this.initLinkService(),this.initDocumentContainer(),this.loadDocument(e),this.setScaleFactor(this.options.zoomLevel)}}loadDocument(e){let t=this.getDocumentParameters(e),{zoom:n}=e;this.clearDocumentState(),xt(t).promise.then(e=>{this.linkService?.setDocument(e),this.initDocumentAnnotationStorage(e),this.initAnnotationEditorUIManager(),this.bindEventBusAnnotationsEvents();let t=[];for(let n=1;n<=e.numPages;n++)t.push(e.getPage(n));return{pagesPromises:t,pdfDoc:e}}).then(({pagesPromises:e,pdfDoc:t})=>(this.state.pagesPromises=e,this.destroyPageComponents(),this.drawPagesFromPromisesAsync(e).then(e=>{this.onPagesLoad({pdfPages:e,pdfDoc:t,zoom:n})}).catch(e=>{this.triggerError(e)}))).catch(e=>{this.triggerError(e)}).finally(()=>{this.linkService?.setDocument(this.pdfDocument)})}initDocumentAnnotationStorage(e){this.state.pdfDocument=e,this.pdfDocument=e,this.annotationStorage=new vi,Object.defineProperty(Object.getPrototypeOf(this.pdfDocument._transport),`annotationStorage`,{get:()=>this.state.isPrintingInProgress?this.annotationStorage?.print:this.annotationStorage,set:e=>{this.annotationStorage=e},configurable:!0}),this._initializeAnnotationStorageCallbacks(e)}_initializeAnnotationStorageCallbacks(e){if(e!==this.pdfDocument)return;let{annotationStorage:t}=e;t.onSetModified=()=>{this._annotationStorageModified=!0},t.onResetModified=()=>{delete this._annotationStorageModified},t.onAnnotationEditor=e=>{this._hasAnnotationEditors=!!e}}drawPagesFromPromisesAsync(e){return Promise.all(e).then(e=>x(this,void 0,void 0,function*(){let t=yield Promise.all(this.drawPagesAsync(e));return this.appendPages(t),e}))}drawPagesAsync(e){if(e||=this.state.pdfPages,!((this.pages||[]).length>0))this.initPageComponents(e);else for(let e=0;e<this.pages.length;e++){let t=this.pages[e].getViewport({scale:this.state.zoomLevel});this.pages[e].viewport=t}let t=[];return e.map((e,n)=>x(this,void 0,void 0,function*(){let r=this.pages[n];if(this.options.loadOnDemand&&n>=this.options.loadOnDemandPageSize&&!r.element){let n=this.createBlankPageElements({pdfPage:e,zoom:this.state.zoomLevel});r&&!r.element&&(r.element=n.pageElement,r.setBlank(!0));let i=je();t.push(i),i.then(e=>e),i.resolve(r.element)}else if(this.options.loadOnDemand&&r.isBlank()){let e=je();t.push(e),e.then(e=>e),e.resolve(r.element)}else{let e=this.drawPageAsync({pageIndex:n});t.push(e),e.then(e=>e)}})),t}createBlankPageElements({pdfPage:e,zoom:t}){let n=this.createPageElements({pdfPage:e,zoom:t});return n.canvasWrapper.appendChild(n.canvas),n.pageElement.appendChild(n.canvasWrapper),n}getDocumentParameters(e){let t={verbosity:0,isEvalSupported:!0};return typeof e.data==`string`&&e.data!==``?t.data=It(e.data):typeof e.url==`string`&&e.url!==``?t.url=e.url:e.arrayBuffer instanceof ArrayBuffer?t=e.arrayBuffer:e.typedArray&&(t=e.typedArray),t}appendPages(e){e.forEach(e=>this.appendPage(e))}appendPage(e,t=null){let n=this.getPagesContainer();Ee(t)?n?.insertBefore(e,n.children[t]):n?.appendChild(e)}drawPageAsync({pageIndex:e=0}){let t=Jt(e,0,Math.max(0,this.state.pdfDocument.numPages-1));return this.pages[t]?.draw().then(()=>(this.triggerPageRendered({page:this.pages[t]}),this.pages[t].element))}createPageElements({pdfPage:e=null,zoom:t=1,printUnits:n=null}){if(t<=0)return;let r=this.getRenderScale();n&&(r=this.getPrintScale());let i=e?.getViewport({scale:r}),{adjustedWidth:a,adjustedHeight:o,adjustRatio:s}=Bt(i.width,i.height),c={width:`round(var(--scale-factor) * ${i.width/r}px, 1px)`,height:`round(var(--scale-factor) * ${i.height/r}px, 1px)`},l=Lt(`div`,`k-page`,c),u=Lt(`canvas`,``,{});u.height=o,u.width=a,n?(u.style.width=`${i.width/r}px`,u.style.height=`${i.height/r}px`):(u.style.width=`100%`,u.style.height=`100%`);let d=u.getContext(`2d`);n&&(d.imageSmoothingEnabled=!1);let f=Oe(`
            <div class="${this.options.elementSelectors.pageCanvasWrapper}"></div>
        `),p=s*r;return i.width=a,i.height=o,i.scale=p,{canvasContext:d,canvasWrapper:f,canvas:u,viewport:i,scaleNum:r,pageElement:l,styles:c}}triggerPageRendered(e){this.trigger(Ec,e)}triggerPagesLoad(e){this.trigger(Dc,e)}triggerZoomStart(e){this.trigger(wc,e)}triggerZoomEnd(e){this.trigger(Tc,e)}triggerDownload(e){return this.trigger(`download`,e)}triggerAnnotationEditorToolBarShow(e){this.trigger(Ac,e)}triggerAnnotationEditorToolBarHide(e){this.trigger(jc,e)}clearDocument(){this.destroyEventBus(),this.unbindEvents(),this.destroySearchService(),this.destroyAnnotationEditorUIManager(),this.clearDocumentState()}clearDocumentState(){this.clearPagesState(),this.state.pdfDocument=null,this.state.pdfPages=[],this.linkService?.setDocument(null)}clearPagesState(){this.pages.forEach(e=>e.destroy()),this.clearPagesElements(),this.pages=[]}initPageComponents(e){let t=this.options.zoomLevel,n=e[0].getViewport({scale:t*gt.PDF_TO_CSS_UNITS});for(let r=1;r<=e.length;r++){let i=r-1,a=new lc(null,{pdfViewer:this,container:this.element,eventBus:this.eventBus,id:r,scale:t,viewport:n,defaultViewport:n,textLayerMode:lr.ENABLE,annotationMode:this.getAnnotationMode(),layerProperties:this._layerProperties});this.pages.push(a),this.pages[i].setPdfPage(e[i])}}destroyPageComponents(){this.pages.forEach(e=>e.destroy()),this.pages=[]}clearPagesElements(){let e=this.getDocumentContainer(),t=this.getPagesContainer();!e||!t||!this.hasDocument()||this.getPagesElements().forEach(e=>{t.removeChild(e)})}initDocumentContainer(){this.documentContainer||(this.documentContainer=this.getDocumentContainer(),this.initDocumentScroller(this.documentContainer))}initDocumentScroller(e){this.documentScroller||!e||(this.documentScroller=this.createDocumentScroller(e,{filter:ke(this.options.elementSelectors.pageSelector),events:{[kc]:this.onDocumentScrollerScroll}}))}createDocumentScroller(e,t){return new Re(e,t)}destroyDocumentScroller(){this.documentScroller&&=(this.documentScroller.destroy(),null)}enableDocumentScrollEventsTracking(){this.documentScroller?.enableScrollEventsTracking()}disableDocumentScrollEventsTracking(){this.documentScroller?.disableScrollEventsTracking()}getCurrentPageIndex(){return zt(this.element)||0}downloadFile({fileName:e,saveOptions:t={}}){this.downloadDocument({options:{pdf:this.state.pdfDocument},fileName:e||this.options.downloadFileName,saveOptions:t})}downloadDocument({options:e,fileName:t=`Document`,saveOptions:n={}}){e.pdf&&this.extractPdfData(e).then(e=>{if(e)return new Blob([e],{type:`application/pdf`})}).then(e=>{e&&!this.triggerDownload({blob:e,fileName:t,saveOptions:n})&&this.saveFile(e,t,n)}).catch(e=>{this.triggerError(e)})}getFileAsByteArray(){return this.extractPdfData({pdf:this.state.pdfDocument})}extractPdfData(e){if(!e.pdf)return Promise.resolve(null);let t=e.pdf.getData.bind(e.pdf),n={},r={};return e.pdf.annotationStorage.size>0&&(t=e.pdf.saveDocument.bind(e.pdf),n={},r=e.pdf.annotationStorage.getAll(),Object.keys(r).forEach(e=>{typeof r[e]?.toJSON==`function`?n[e]=r[e].toJSON():n[e]=r[e]}),Object.keys(r).forEach(t=>{e.pdf.annotationStorage.remove(t)}),Object.keys(n).forEach(t=>{e.pdf.annotationStorage.setValue(t,n[t])})),t().then(e=>e).catch(e=>(this.triggerError(e),null)).finally(()=>{if(e.pdf?.annotationStorage.size<=0)return;let t=e.pdf.annotationStorage.getAll();Object.keys(t).forEach(t=>{e.pdf.annotationStorage.remove(t)}),Object.keys(r).forEach(t=>{e.pdf.annotationStorage.setValue(t,r[t])})})}saveFile(e,t,n){try{Ye(e,t,n)}catch{return!1}return!0}hasDocument(){return Ee(this.state.pdfDocument)}zoom(e){e.zoomLevel=this.calculateZoomLevel({zoomLevel:e.zoomLevel,zoomLevelType:e.zoomLevelType,currentZoom:this.options.zoomLevel}),this.options.zoomLevel=e.zoomLevel,this.state.zoomLevel=e.zoomLevel,this.eventBus.dispatch(`scalechanging`,{source:this,scale:this.options.zoomLevel}),this.reloadFile(this.state.pdfDocument)}calculateZoomLevel({zoomLevel:e,zoomLevelType:t,currentZoom:n}){let r=this.getDocumentContainer(),i=r.querySelector(ke(this.options.elementSelectors.anyPageSelector)),a=Jt(e||Mc,this.options.minZoom,this.options.maxZoom);if(!Ee(i))return a;let o={width:i.offsetWidth,height:i.offsetHeight};return t===`ActualWidth`||t===`actualWidth`?a=1:t===`FitToWidth`||t===`fitToWidth`?a=r.offsetWidth/(o.width/n):(t===`FitToPage`||t===`fitToPage`)&&(a=r.offsetHeight/(o.height/n)),a}reloadFile(e){let t=[];for(let n=1;n<=e.numPages;n++)t.push(e.getPage(n));this.disableDocumentScrollEventsTracking(),this.drawPagesFromPromisesAsync(t).then(t=>{this.onPagesLoad({pdfPages:t,pdfDoc:e})}).catch(e=>{this.triggerError(e)}),this.setScaleFactor(this.state.zoomLevel)}setHiddenCanvasStyles(){this.options.pdfjsSetHiddenCanvasStyles&&Vt(this.getPagesContainer().ownerDocument)}printFile(){this.hasDocument()&&(this.setState({isPrintingInProgress:!0}),this.options.zoomBeforePrint?(this.cacheZoomLevelBeforePrint(),this.loadDocumentForPrintAsync({zoomLevel:this.options.zoomLevelBeforePrint,force:!0}).then(()=>{this.printDocumentAsync().then(()=>{this.trigger(Oc)})}).catch(this.triggerError).finally(()=>{this.setState({isPrintingInProgress:!1}),this.restoreZoomLevelBeforePrint()})):this.loadDocumentForPrintAsync({zoomLevel:this.state.zoomLevel,force:!0}).then(()=>{this.printDocumentAsync().then(()=>{this.trigger(Oc)})}).catch(this.triggerError).finally(()=>{this.setState({isPrintingInProgress:!1})}))}loadDocumentForPrintAsync({zoomLevel:e=Mc,force:t=!1}){let n=this.pages,r=[],i=je();for(let i=0;i<n.length;i++){let a=n[i].loadForPrintAsync({zoomLevel:e,force:t});r.push(a)}return Promise.all(r).then(()=>{i.resolve()}),i}getPagesPrintContentAsync(e){let t=this.pages,n=[];for(let r=0;r<t.length;r++){let i=t[r].getPrintContentAsync();i.then(t=>{let n=Oe(`<div></div>`);n.appendChild(t),e.appendChild(n)}),n.push(i)}return n}initPrintContainer(){this.printContainer=Oe(`<div></div>`)}openPrintDialog(){let e=this.pages,t=e[0].rawWidth*this.getPdfToCssUnits(),n=e[0].rawHeight*this.getPdfToCssUnits(),r=window.open(``,``,`innerWidth=`+t+`,innerHeight=`+n+`location=no,titlebar=no,toolbar=no`);if(!r||!r.document){this.triggerError({message:this.options.messages.errorMessages.popupBlocked});return}r.document.body.style.margin=`0`,r.document.body.appendChild(this.printContainer);let i=()=>{r.removeEventListener(`afterprint`,i),r.close()};r.addEventListener(`afterprint`,i),r.focus(),r.print()}cacheZoomLevelBeforePrint(){this.setState({zoomLevelBeforePrint:this.state.zoomLevel})}restoreZoomLevelBeforePrint(){this.state.zoomLevelBeforePrint!==this.state.zoomLevel&&this.zoom({zoomLevel:this.state.zoomLevelBeforePrint,zoomLevelType:this.state.zoomLevelType,currentZoom:this.state.zoomLevel})}searchText(e={text:``,matchCase:!1}){return this.initSearchService(),this.searchService?.search(e)}clearSearch(){this.destroySearchService()}initSearchService(){let e=Array.from(this.wrapper.querySelectorAll(ke(this.options.elementSelectors.textLayerClass))||[]);if(this.searchService){if(e.every((e,t)=>e===this.searchService.options.textContainers[t]))return;this.destroySearchService()}this.searchService=new Je({textContainers:e,highlightClass:this.options.elementSelectors.searchHighlightClass,highlightMarkClass:this.options.elementSelectors.searchHighlightMarkClass,charClass:this.options.elementSelectors.charClass})}destroySearchService(){this.searchService&&=(this.searchService.destroy(),null)}goToNextSearchMatch(){if(!this.searchService)return;this.searchService.markNextMatch();let e=this.searchService.getActiveMatchElement();this.scrollToSearchMatch(e)}goToPreviousSearchMatch(){if(!this.searchService)return;this.searchService.markPreviousMatch();let e=this.searchService.getActiveMatchElement();this.scrollToSearchMatch(e)}getPagesContainer(){return this.element.querySelector(ke(this.options.elementSelectors.pagesContainerClass))}getDocumentContainer(){return this.wrapper.querySelector(ke(this.options.elementSelectors.documentContainerClass))}getPagesElements(){let e=this.getDocumentContainer();return e?Ce(e.querySelectorAll(ke(this.options.elementSelectors.pageSelector))):[]}scrollToSearchMatch(e){if(!e)return;let t=e.closest(`.k-text-char`),n=t?t.closest(`span[role="presentation"]`):null;if(!n)return;let r=n.closest(`.k-page`);if(!r)return;let i=r.offsetLeft+-1*this.documentScroller.element.offsetLeft+n.offsetLeft+this.options.searchMatchScrollLeftOffset,a=r.offsetTop+-1*this.documentScroller.element.offsetTop+n.offsetTop+this.options.searchMatchScrollTopOffset;this.documentScroller.scrollTo(i,a,{trackScrollEvent:!1})}resetInteractionMode(){this.setInteractionMode({mode:mc.TextSelection})}setInteractionMode(e){this.interactionMode=e.mode,this.interactionMode===mc.TextSelection?(this.disableScrollerEventsTracking(),Kt(this.options.elementSelectors.enabledTextSelectionClass,this.documentScroller.element),qt(this.options.elementSelectors.enabledPanningClass,this.documentScroller.element)):this.interactionMode===mc.Pan&&(this.enableScrollerEventsTracking(),qt(this.options.elementSelectors.enabledTextSelectionClass,this.documentScroller.element),Kt(this.options.elementSelectors.enabledPanningClass,this.documentScroller.element))}enableScrollerEventsTracking(){this.documentScroller&&this.documentScroller.enablePanEventsTracking()}disableScrollerEventsTracking(){this.documentScroller&&this.documentScroller.disablePanEventsTracking()}setScaleFactor(e){this.element.style.setProperty(`--scale-factor`,String(e*gt.PDF_TO_CSS_UNITS))}activatePageNumber(e){let t=this.getPageByNumber(e);if(!t)return;let n=e-1;this.state.activePageNumber!==e&&(this.state.activePageNumber=e,t.isBlank()?this.drawPageAsync({pageIndex:n}).then(()=>{this.scrollToPage({pageNumber:e})}):this.scrollToPage({pageNumber:e}))}scrollToPage({pageNumber:e}){let{left:t,top:n}=this.getPageNumberScrollOffset(e);this.scrollDocument({left:t,top:n})}scrollDocument({left:e,top:t}){this.documentScroller?.scrollTo(e,t,{trackScrollEvent:!1})}getPageNumberScrollOffset(e){return this.getPageByNumber(e)?{left:0,top:this.pages.slice(0,Math.max(0,e-1)).map(e=>this.getPageScrollOffset(e)).reduce((e,t)=>e+t,0)}:{left:0,top:0}}getPageScrollOffset(e){let t=(e?.element)?.getBoundingClientRect().height||0,n=getComputedStyle(e.element);return t+(parseFloat(n.marginTop)||0)}getPageByNumber(e){return this.pages&&this.pages[e-1]}addHighlightAnnotation(){this.annotationEditorUIManager?.highlightSelection()}setHighlightColor(e){this.executeAnnotationCommand({commandType:b.HIGHLIGHT_COLOR,commandValue:e})}deleteAnnotation(){this.annotationEditorUIManager?.delete()}resetAnnotationEditorMode(){this.setAnnotationEditorMode({mode:y.NONE,editId:null,isFromKeyboard:!1})}setAnnotationEditorMode(e){this.annotationEditorMode=e}setAnnotationMode(e){C(this,vc,e,`f`)}setEditAnnotationMode(){C(this,vc,Xt.ENABLE_FORMS,`f`)}resetAnnotationMode(){C(this,vc,Xt.ENABLE,`f`)}setFreeTextColor(e){this.executeAnnotationCommand({commandType:b.FREETEXT_COLOR,commandValue:e})}setFreeTextFontSize(e){this.executeAnnotationCommand({commandType:b.FREETEXT_SIZE,commandValue:parseFloat(e)})}executeAnnotationCommand({commandType:e,commandValue:t}){this.eventBus.dispatch(`switchannotationeditorparams`,{source:this,type:e,value:t})}isValidAnnotationEditorMode(e){return Object.values(y).includes(e)&&e!==y.DISABLE}cleanupSwitchAnnotationEditorMode(){S(this,bc,`f`)&&(this.eventBus._off(`pagerendered`,S(this,bc,`f`)),C(this,bc,null,`f`)),S(this,_c,`f`)!==null&&(clearTimeout(S(this,_c,`f`)),C(this,_c,null,`f`))}_getVisiblePages(){return this.pages}get _layerProperties(){let e=this;return pt(this,`_layerProperties`,{get annotationEditorUIManager(){return e.annotationEditorUIManager},get annotationStorage(){return e.pdfDocument?.annotationStorage},get linkService(){return e.linkService}})}scrollPageIntoView({pageNumber:e,destArray:t=null,allowNegativeOffset:n=!1,ignoreDestinationZoom:r=!1}){if(!this.pdfDocument)return;let i=Number.isInteger(e)&&this.pages[e-1];if(!i)return;if(this.isInPresentationMode||!t){this._setCurrentPageNumber(e,!0);return}let a=0,o=0,s=(i.rotation%180==0?i.rawHeight:i.rawWidth)/i.scale/gt.PDF_TO_CSS_UNITS;switch(t[1].name){case`XYZ`:a=t[2],o=t[3],a=a===null?0:a,o=o===null?s:o;break;default:return}let c=[i.viewport.convertToViewportPoint(a,o),i.viewport.convertToViewportPoint(a+0,o+0)],l=Math.min(c[0][0],c[1][0]),u=Math.min(c[0][1],c[1][1]);n||(l=Math.max(l,0),u=Math.max(u,0)),S(this,hc,`m`,Sc).call(this,i,{left:l,top:u})}_setCurrentPageNumber(e,t=!1){if(this._currentPageNumber===e)return!0;if(!(0<e&&e<=this.state.pdfDocument.numPages))return!1;let n=this._currentPageNumber;return this._currentPageNumber=e,this.eventBus.dispatch(`pagechanging`,{source:this,pageNumber:e,previous:n}),!0}};gc=new WeakMap,_c=new WeakMap,vc=new WeakMap,yc=new WeakMap,bc=new WeakMap,hc=new WeakSet,xc=function(){let e=[],t=new Set;this.pages.forEach(e=>{t.add(e.id)});for(let n of this.pages){let r=n;if(!r.hasEditableAnnotations()){t.delete(r.id);continue}e.push(n)}return e.length===0?null:(this.drawPagesAsync(this.state.pdfPages),t)},Sc=function(e,t=null){let{div:n,id:r}=e;if(this._currentPageNumber!==r&&this._setCurrentPageNumber(r),!t&&!this.isInPresentationMode){let e=n.offsetLeft+n.clientLeft,r=e+n.clientWidth,{scrollLeft:i,clientWidth:a}=this.element;(this._scrollMode===ur.HORIZONTAL||e<i||r>i+a)&&(t={left:0,top:0})}dr(n,t)};let Pc=jQuery,Fc={DISABLE:-1,NONE:0,FREETEXT:3,HIGHLIGHT:9};var Ic=class{constructor(e){this.viewer=e,this.widget=e.pdfViewerCommon,this.init()}init(){let e=this.element=Pc(`<div></div>`);e.insertAfter(this.viewer.toolbar.element);let t=this.toolbar=new kendo.ui.ToolBar(e,{fillMode:`flat`,tools:[{name:`highlight`,command:`highlight`,icon:`highlight`,type:`button`,togglable:!0,showText:`overflow`,group:`annotations`,fillMode:`flat`},{type:`separator`},{name:`freeText`,command:`freeText`,icon:`free-text`,type:`button`,togglable:!0,showText:`overflow`,group:`annotations`,fillMode:`flat`},{type:`spacer`},{name:`close`,command:`close`,icon:`x`,type:`button`,showText:`overflow`,fillMode:`flat`}],parentMessages:{highlight:`Highlight`,freeText:`Free text`,close:`Close`}});t.bind(`click`,this.onToolbarClick.bind(this)),t.bind(`toggle`,this.onToolbarClick.bind(this))}onToolbarClick(e){let t=this.widget,n=Pc(e.target).data(`command`),r=this.viewer.toolbar;switch(n){case`close`:this.destroy(),r.element.find(`[tabindex=0]`).trigger(`focus`);break;case`highlight`:oe(t,{interactionMode:mc.TextSelection,mode:Fc.HIGHLIGHT});break;case`freeText`:oe(t,{interactionMode:mc.TextSelection,mode:Fc.FREETEXT});break}}destroy(){this.toolbar&&(this.viewer.toolbar.toggle(`[title='Annotations']`,!1),this.toolbar.unbind(`click`),this.toolbar.unbind(`toggle`),this.toolbar.destroy(),this.toolbar=null,this.element.remove(),this.element=null,this.viewer.annotationsToolbar=null,se(this.widget))}};(function(e,t){var n=window.kendo,r=e.extend,i=n.ui.progress,a=n.Class,o=n.pdfviewer.UploadHelper,s=`zoomStart`,c=`zoomEnd`,l=a.extend({init:function(e){this.options=e,this.viewer=e.viewer,this.errorMessages=this.viewer.options.messages.errorMessages}}),u=l.extend({init:function(e){l.fn.init.call(this,e),this._uploadHelper=new o(this.viewer)},exec:function(){this.viewer._upload=this.viewer._upload||this._uploadHelper._initUpload(),this.viewer._upload.element.click()}}),d=l.extend({exec:function(){var e=this.options.value,t=this.viewer,n,r;if(isNaN(e))switch(n=t._pageNum,r=t.document.total||t.document.numPages,e){case`first`:e=1;break;case`prev`:e=n>1?n-1:1;break;case`next`:e=n<r?n+1:r;break;case`last`:e=r;break}else e=Number(e);t.activatePage(e,!1)}}),f=l.extend({exec:function(){let e=this;if(!e.viewer.document){e.viewer._triggerError({message:e.errorMessages.notFound});return}let t=e.viewer.document.info&&e.viewer.document.info.title||e.viewer.options.messages.defaultFileName;e.viewer._isDPLProcessor()?e.viewer.processor.downloadFile(t):e.viewer.pdfViewerCommon.downloadFile({fileName:t})}}),p=l.extend({init:function(t){t=e.extend(t,this.options),l.fn.init.call(this,t)},exec:function(){var e=this.viewer._saveDialog||this._initDialog();e._updateModel({pagesCount:this.viewer.document&&this.viewer.document.total||1,page:this.viewer.options.page}),e.open()},apply:function(e){var t=e.extension;t===`.png`?this.viewer.exportImage(e):t===`.svg`&&this.viewer.exportSVG(e)},_initDialog:function(){return this.viewer._saveDialog=new n.pdfviewer.dialogs.ExportAsDialog({apply:this.apply.bind(this),pagesCount:this.viewer.document&&this.viewer.document.total||1,messages:this.viewer.options.messages}),this.viewer._saveDialog}}),m=l.extend({exec:function(){let e=this.viewer;e.toolbar.enable(e.toolbar.element.find(`[data-command=AnnotationsCommand]`),!0),ce(e.pdfViewerCommon,mc.TextSelection)}}),h=l.extend({exec:function(){let e=this.viewer;e.toolbar.enable(e.toolbar.element.find(`[data-command=AnnotationsCommand]`),!1),e.annotationsToolbar&&e.annotationsToolbar.destroy(),se(e.pdfViewerCommon),ce(e.pdfViewerCommon,mc.Pan)}});let ee=l.extend({init:function(e){let t=this;t.viewer=e.viewer,t.viewer.searchDialog||(t.viewer.searchDialog=new n.pdfviewer.dialogs.SearchDialog({pageContainer:t.viewer.pageContainerWrapper,position:{top:t.viewer.pageContainer.offset().top,left:t.viewer.pageContainer.offset().left},messages:t.viewer.options.messages.dialogs.search,open:t._open.bind(t),next:t._next.bind(t),prev:t._prev.bind(t),close:t._close.bind(t)})),l.fn.init.call(t,e)},exec:function(){this.viewer.searchDialog.open()},_open:function(){let e=this;e.changeHandler=e._change.bind(e),e.viewer.searchDialog.searchModel.bind(`change`,e.changeHandler)},_close:function(){let e=this;e.viewer.pdfViewerCommon.clearSearch(),e.viewer.toolbar.element.find(`[tabindex=0]`).trigger(`focus`),e.viewer.searchDialog.searchModel.unbind(`change`,e.changeHandler),e.matches=[],e.matchIndex=null,e._updateSearchModel()},_change:function(e){let t=this,n=t.viewer.searchDialog.searchModel.searchText,r=t.viewer.searchDialog.searchModel.matchCase;(e.field===`searchText`||e.field===`matchCase`)&&(t.matches=t.viewer.pdfViewerCommon.searchText({text:n,matchCase:r}),t.matchIndex=t.matches.length?1:0,t._updateSearchModel())},_next:function(){let e=this;e.viewer.pdfViewerCommon.goToNextSearchMatch(),e.matchIndex=e.matchIndex+1>e.matches.length?1:e.matchIndex+1,e._updateSearchModel()},_prev:function(){let e=this;e.viewer.pdfViewerCommon.goToPreviousSearchMatch(),e.matchIndex=e.matchIndex-1<1?e.matches.length:e.matchIndex-1,e._updateSearchModel()},_updateSearchModel:function(){let e=this,t=e.viewer.searchDialog.searchModel;e.matches&&e.matches.length?(t.set(`matches`,e.matches.length),t.set(`matchIndex`,e.matchIndex)):(t.set(`searchText`,``),t.set(`matches`,0),t.set(`matchIndex`,0))},_closeDialog:function(){this.viewer.searchDialog.close()}});var g=l.extend({exec:function(){let e=this,n=e._calculateZoom();if(n===t)return;let r=n.zoomLevel;e.viewer.zoomScale!==n.zoomLevel&&(e.viewer._preventRenderEvent=!0,e.viewer._currentPage=e.viewer.pdfViewerCommon.getCurrentPageIndex()+1,e.viewer.pdfViewerCommon.zoom({zoomLevel:n.zoomLevel,zoomLevelType:n.zoomLevelType}),r=e.viewer.pdfViewerCommon.options.zoomLevel,e._triggerZoomEnd(r)),e.viewer.zoomScale=r},_calculateZoom:function(){var e=this.options,t=this.viewer,r=t.options,i=e.value||e.scale,a=i,o=``,c;if(t._allowResize=!1,t._autoFit=!1,e.zoomIn?a=i=t.zoomScale+r.zoomRate:e.zoomOut?a=i=t.zoomScale-r.zoomRate:i===`auto`?(t._allowResize=!0,a=t._autoZoomScale):typeof i==`string`&&!n.parseFloat(i)?o=i:i&&i.toString().match(/^[0-9]+%?$/)?(i=parseInt(i.replace(`%`,``),10)/100,a=i):c=isNaN(i),c||=i<r.zoomMin||i>r.zoomMax,!(c||t.trigger(s,{scale:i})))return e.updateComboBox&&t.toolbar&&t._updateZoomComboBox(i),{zoomLevel:a,zoomLevelType:o}},_triggerZoomEnd:function(e){this.viewer.trigger(c,{scale:e})}}),te=l.extend({init:function(e){l.fn.init.call(this,e)},exec:function(){let e=this;if(!e.viewer.document){e.viewer._triggerError({message:this.errorMessages.notFound});return}i(e.viewer.pageContainerWrapper,!0),setTimeout(()=>{e.viewer.pdfViewerCommon.printFile()},100)}});let ne=l.extend({init:function(e){l.fn.init.call(this,e)},exec:function(){let e=this.viewer;e.annotationsToolbar?e.annotationsToolbar.destroy():e.annotationsToolbar=new Ic(e)}});r(n.pdfviewer,{OpenCommand:u,PageChangeCommand:d,DownloadCommand:f,EnableSelectionCommand:m,EnablePanCommand:h,ExportCommand:p,PrintCommand:te,OpenSearchCommand:ee,ZoomCommand:g,AnnotationsCommand:ne})})(window.kendo.jQuery),(function(e,t){var n=window.kendo,r=n.htmlEncode,i=e.extend,a=n.Class,o=n.ui.Draggable,s=n._outerWidth,c={svg:`.svg`,png:`.png`},l=n.keys,u=a.extend({init:function(t){this.options=i(t,{actions:[{text:t.messages.dialogs.okText}]}),this._dialog=e(`<div />`).kendoDialog(this.options).getKendoDialog()},open:function(){this._dialog.center().open()}}),d=a.extend({init:function(e){return this.options=i(e,this.options,{fileFormats:[{description:e.messages.dialogs.exportAsDialog.png,extension:c.png},{description:e.messages.dialogs.exportAsDialog.svg,extension:c.svg}],title:e.messages.dialogs.exportAsDialog.title,open:function(){this.center()}}),this._initializeDialog(),this},options:{extension:c.png,autoFocus:!0,resizable:!1,modal:{preventScroll:!0},width:`90%`,maxWidth:520,template:({messages:e,total:t})=>`<div class='k-edit-label'><label>${r(e.exportAsDialog.labels.fileName)}:</label></div><div class='k-edit-field'><span class='k-textbox k-input'><input class='k-input-inner' data-bind='value: name' /></span></div><div><div class='k-edit-label'><label>${r(e.exportAsDialog.labels.saveAsType)}:</label></div><div class='k-edit-field'><select data-role='dropdownlist' class='k-file-format' data-text-field='description' data-value-field='extension' data-bind='value: extension, source: fileFormats'></select></div></div><div class='k-edit-label'><label>${r(e.exportAsDialog.labels.page)}:</label></div><div class='k-edit-field'><input data-role='numerictextbox' data-format='n0' data-min='1' data-max='${r(t)}' data-bind='value: page' /></div><div class='k-actions'><button class='k-button k-button-primary' data-bind='click: apply'><span class='k-button-text'>${r(e.save)}</span></button><button class='k-button' data-bind='click: close'><span class='k-button-text'>${r(e.cancel)}</span></button></div>`},_updateModel:function(e){e.pagesCount&&this.viewModel.set(`pagesCount`,e.pagesCount),e.page&&this.viewModel.set(`page`,e.page)},_initializeDialog:function(){var t=this,r=t.options,i=r.messages.dialogs,a=e(`<div class='k-pdf-viewer-window k-action-window k-popup-edit-form' />`).append(n.template(r.template)({total:r.pagesCount,messages:i})).kendoWindow(r).getKendoWindow();return t.viewModel=n.observable({title:i.exportAsDialog.title,name:i.exportAsDialog.defaultFileName,extension:r.extension,fileFormats:r.fileFormats,pagesCount:r.pagesCount,page:1,apply:t.apply.bind(this),close:function(){a.close()}}),t._dialog=a,n.bind(a.element,t.viewModel),a},open:function(){this._dialog.center().open()},apply:function(){this._dialog.close(),this.options.apply({fileName:this.viewModel.name+this.viewModel.extension,extension:this.viewModel.extension,page:this.viewModel.page})}}),f=a.extend({init:function(e){var t=this;t.options=i({},e,t.options)},options:{resizable:!1,template:({messages:e})=>`<div class="k-search-panel k-pos-sticky k-top-center"><button aria-label='${r(e.dragHandle)}' class='k-button k-button-flat k-icon-button k-search-dialog-draghandle'>${n.ui.icon({icon:`handle-drag`,iconClass:`k-button-icon`})}</button><span class='k-textbox k-input'><input class='k-search-dialog-input k-input-inner' data-bind='value: boundValue, events: { keyup: onKeyup, input: onInput }' aria-label='${r(e.inputLabel)}' title='${r(e.inputLabel)}' /><span class='k-input-suffix'><button class='k-button k-button-flat k-icon-button k-match-case-button k-match-case-button' data-bind='css: {k-selected: matchCase}, click: matchCaseClick' aria-label='${r(e.matchCase)}' title='${r(e.matchCase)}'>${n.ui.icon({icon:`convert-lowercase`,iconClass:`k-button-icon`})}</button></span></span><span class='k-search-matches'><span data-bind='text: matchIndex'></span> ${r(e.of)} <span data-bind='text: matches'></span></span><button class='k-button k-button-flat k-icon-button' data-bind='click: prev' aria-label='${r(e.previous)}' title='${r(e.previous)}'>${n.ui.icon({icon:`arrow-up`,iconClass:`k-button-icon`})}</button><button class='k-button k-button-flat k-icon-button' data-bind='click: next' aria-label='${r(e.next)}' title='${r(e.next)}'>${n.ui.icon({icon:`arrow-down`,iconClass:`k-button-icon`})}</button><button class='k-button k-button-flat k-icon-button' data-bind='click: close' aria-label='${r(e.close)}' title='${r(e.close)}'>${n.ui.icon({icon:`x`,iconClass:`k-button-icon`})}</button></div>`},open:function(){var e=this;e.dialog||e._initializeDialog(),e.options.open(),e._showSearchDialog()},close:function(){var e=this;e.options.close(),e._hideSearchDialog()},_showSearchDialog:function(){var e=this;e.dialog.css(`left`,`${e.options.pageContainer.innerWidth()/2-s(e.dialog,!0)/2}px`),e.dialog.kendoStop().kendoAnimate({effects:{zoom:{direction:`in`},fade:{direction:`in`}},duration:350,complete:function(t){e.dialog.find(`.k-search-dialog-input`).trigger(`focus`)}})},_hideSearchDialog:function(){this.dialog.kendoStop().kendoAnimate({effects:{zoom:{direction:`out`,properties:{scale:.7}},fade:{direction:`out`}},duration:350,hide:!0})},_initializeDialog:function(){var t=this,r=e(n.template(t.options.template)({messages:t.options.messages}));t.options.pageContainer.prepend(r),t.dialog=r,t._draggable=new o(r,{filter:`.k-search-dialog-draghandle`,axis:`x`,dragstart:function(e){var r=t.dialog,i=t.options.pageContainer;if(r.startPosition={left:e.x.client-n.getOffset(r,`position`).left},!i)return null;i._innerWidth=i.innerWidth(),parseInt(i._innerWidth,10)>i[0].clientWidth&&(i._innerWidth-=n.support.scrollbar()),r.maxLeft=i._innerWidth-s(r,!0)},drag:function(e){var n=t.dialog,r={},i=e.x.client-n.startPosition.left;i&&isNaN(i)&&i.toString().indexOf(`px`)<0?r.left=i:r.left=Math.max(Math.min(parseInt(i,10),parseInt(n.maxLeft,10)),0),n.css(r)}}),t._draggable.userEvents.stopPropagation=!1,t.searchModel=n.observable({boundValue:``,searchText:``,matchCase:!1,matchIndex:0,matches:0,matchCaseClick:function(){this.set(`matchCase`,!this.matchCase)},next:t.options.next,prev:t.options.prev,close:function(){this.set(`boundValue`,``),t.close()},onKeyup:function(e){var t=e.keyCode,n=e.shiftKey?this.prev:this.next;t===l.ENTER?(n(),e.preventDefault()):t==l.ESC&&this.close()},onInput:function(e){this.set(`searchText`,e.target.value)}}),n.bind(r,t.searchModel)}});i(n.pdfviewer,{dialogs:{ErrorDialog:u,ExportAsDialog:d,SearchDialog:f}})})(window.kendo.jQuery);let Lc=jQuery;var Rc=class{constructor(e,t,n){this.viewer=e,this.widget=e.pdfViewerCommon,this.anchor=t,this.editor=n,this.popupOpenHandler=this.onPopupOpen.bind(this),this.init()}init(){let e=this.anchor,t=Lc(`<div data-uid="${kendo.guid()}"></div>`);this.popup=new kendo.ui.Popup(Lc(`<div class="k-pdf-viewer-annotation-editor-toolbar"></div>`),{anchor:e}),this.popup.element.html(t),(this.popupToolbar=new kendo.ui.ToolBar(t,{fillMode:`flat`,tools:[{name:`palette`,command:`palette`,icon:`palette`,type:`button`,showText:`overflow`,fillMode:`flat`},{name:`remove`,command:`remove`,icon:`trash`,type:`button`,showText:`overflow`,fillMode:`flat`}],parentMessages:{palette:`Palette`,remove:`Remove`}})).bind(`click`,this.onAnnotationPopupToolbarClick.bind(this)),this.popup.open()}initEditor(){}onAnnotationPopupToolbarClick(e){let t=this.widget;switch(Lc(e.target).data(`command`)){case`palette`:this.initEditor();break;case`remove`:ne(t),this.destroyPopup();break;default:break}}onPopupOpen(){this.flatColorPicker._view._hueSlider.resize(),this.flatColorPicker._view._opacitySlider.resize()}anchorExists(){return document.getElementById(this.anchor.id)}destroyPopup(){this.popup&&=(this.popup.destroy(),null)}destroyEditor(){this.editorPopup&&=(this.editorPopup.destroy(),null)}destroy(){this.popupToolbar&&=(this.popupToolbar.unbind(`click`),this.popupToolbar.unbind(`toggle`),this.popupToolbar.destroy(),null),this.destroyPopup()}},zc=class extends Rc{constructor(e,t,n){super(e,t,n)}initEditor(){let e=this.anchor;if(!this.anchorExists()){this.destroy();return}this.destroyEditor(),this.editorPopup=new kendo.ui.Popup(Lc(`
